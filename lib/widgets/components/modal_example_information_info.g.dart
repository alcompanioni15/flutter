...
class ModalExampleInformationInfo extends StatefulWidget {
  ...
  const ModalExampleInformationInfo(
    this.constraints, {
    Key? key,
  ...
  @override
  _ModalExampleInformationInfo createState() => _ModalExampleInformationInfo();
}

class _ModalExampleInformationInfo extends State<ModalExampleInformationInfo> {
  _ModalExampleInformationInfo();
