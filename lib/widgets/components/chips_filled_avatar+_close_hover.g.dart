...
class ChipsFilledAvatarCloseHover extends StatefulWidget {
  ...
  @override
  _ChipsFilledAvatarCloseHover createState() => _ChipsFilledAvatarCloseHover();
}

class _ChipsFilledAvatarCloseHover extends State<ChipsFilledAvatarCloseHover> {
  _ChipsFilledAvatarCloseHover();
