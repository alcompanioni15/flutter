...
class ChipsFilledLeftCloseDefault extends StatefulWidget {
  ...
  const ChipsFilledLeftCloseDefault(
    this.constraints, {
    Key? key,
  ...
  @override
  _ChipsFilledLeftCloseDefault createState() => _ChipsFilledLeftCloseDefault();
}

class _ChipsFilledLeftCloseDefault extends State<ChipsFilledLeftCloseDefault> {
  _ChipsFilledLeftCloseDefault();
