...
class ButtonOutlinedAccentLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedAccentLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedAccentLeftIconPressed createState() =>
      _ButtonOutlinedAccentLeftIconPressed();
}

class _ButtonOutlinedAccentLeftIconPressed
    extends State<ButtonOutlinedAccentLeftIconPressed> {
  _ButtonOutlinedAccentLeftIconPressed();
