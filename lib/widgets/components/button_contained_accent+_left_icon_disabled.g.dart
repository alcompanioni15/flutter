...
class ButtonContainedAccentLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedAccentLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedAccentLeftIconDisabled createState() =>
      _ButtonContainedAccentLeftIconDisabled();
}

class _ButtonContainedAccentLeftIconDisabled
    extends State<ButtonContainedAccentLeftIconDisabled> {
  _ButtonContainedAccentLeftIconDisabled();
