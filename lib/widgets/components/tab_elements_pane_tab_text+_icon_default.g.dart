...
class TabElementsPaneTabTextIconDefault extends StatefulWidget {
  ...
  @override
  _TabElementsPaneTabTextIconDefault createState() =>
      _TabElementsPaneTabTextIconDefault();
}

class _TabElementsPaneTabTextIconDefault
    extends State<TabElementsPaneTabTextIconDefault> {
  _TabElementsPaneTabTextIconDefault();
                ...
                child: LayoutBuilder(builder: (context, constraints) {
                  return IconOutlinedEditorOtherEditForm(
                    ...
                    ovrVector2: SvgPicture.asset(
                      ...
                      width: widget.constraints.maxWidth * 0.06676726645611702,
                      fit: BoxFit.fill,
                    ),
                  );
                }),
