...
class CircularButtonOutlinedAccentDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonOutlinedAccentDisabled(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedAccentDisabled createState() =>
      _CircularButtonOutlinedAccentDisabled();
}

class _CircularButtonOutlinedAccentDisabled
    extends State<CircularButtonOutlinedAccentDisabled> {
  _CircularButtonOutlinedAccentDisabled();
