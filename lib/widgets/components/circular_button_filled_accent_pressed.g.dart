...
class CircularButtonFilledAccentPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFilledAccentPressed(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFilledAccentPressed createState() =>
      _CircularButtonFilledAccentPressed();
}

class _CircularButtonFilledAccentPressed
    extends State<CircularButtonFilledAccentPressed> {
  _CircularButtonFilledAccentPressed();
