...
class ButtonOutlinedSuccessLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedSuccessLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedSuccessLeftIconDefault createState() =>
      _ButtonOutlinedSuccessLeftIconDefault();
}

class _ButtonOutlinedSuccessLeftIconDefault
    extends State<ButtonOutlinedSuccessLeftIconDefault> {
  _ButtonOutlinedSuccessLeftIconDefault();
