...
class TextfieldLineInputRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrPlaceholder;
  final Widget? ovriconoutlinedactioneyeeyeon;
  const TextfieldLineInputRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrPlaceholder,
  ...
  @override
  _TextfieldLineInputRightIconDisabled createState() =>
      _TextfieldLineInputRightIconDisabled();
}

class _TextfieldLineInputRightIconDisabled
    extends State<TextfieldLineInputRightIconDisabled> {
  _TextfieldLineInputRightIconDisabled();
