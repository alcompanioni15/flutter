...
class CircularButtonOutlinedSuccessPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonOutlinedSuccessPressed(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedSuccessPressed createState() =>
      _CircularButtonOutlinedSuccessPressed();
}

class _CircularButtonOutlinedSuccessPressed
    extends State<CircularButtonOutlinedSuccessPressed> {
  _CircularButtonOutlinedSuccessPressed();
