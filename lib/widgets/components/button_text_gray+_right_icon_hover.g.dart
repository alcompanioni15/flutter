...
class ButtonTextGrayRightIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrCursorPointinghand;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextGrayRightIconHover(
    this.constraints, {
    Key? key,
  ...
  @override
  _ButtonTextGrayRightIconHover createState() =>
      _ButtonTextGrayRightIconHover();
}

class _ButtonTextGrayRightIconHover
    extends State<ButtonTextGrayRightIconHover> {
  _ButtonTextGrayRightIconHover();
