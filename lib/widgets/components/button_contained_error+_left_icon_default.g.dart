...
class ButtonContainedErrorLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedErrorLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedErrorLeftIconDefault createState() =>
      _ButtonContainedErrorLeftIconDefault();
}

class _ButtonContainedErrorLeftIconDefault
    extends State<ButtonContainedErrorLeftIconDefault> {
  _ButtonContainedErrorLeftIconDefault();
