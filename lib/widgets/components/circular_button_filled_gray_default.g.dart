...
class CircularButtonFilledGrayDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFilledGrayDefault(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFilledGrayDefault createState() =>
      _CircularButtonFilledGrayDefault();
}

class _CircularButtonFilledGrayDefault
    extends State<CircularButtonFilledGrayDefault> {
  _CircularButtonFilledGrayDefault();
