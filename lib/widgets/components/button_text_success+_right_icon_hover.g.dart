...
class ButtonTextSuccessRightIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrCursorPointinghand;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextSuccessRightIconHover(
    this.constraints, {
    Key? key,
  ...
  @override
  _ButtonTextSuccessRightIconHover createState() =>
      _ButtonTextSuccessRightIconHover();
}

class _ButtonTextSuccessRightIconHover
    extends State<ButtonTextSuccessRightIconHover> {
  _ButtonTextSuccessRightIconHover();
