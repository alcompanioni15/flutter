...
class BreadcrumbsElementsTextIconCenterSeparatorHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrlinklabel;
  final Widget? ovrCursorPointinghand;
  final Widget? ovriconoutlinedotherlocationhome;
  final String? ovrdivider;
  const BreadcrumbsElementsTextIconCenterSeparatorHover(
    this.constraints, {
    Key? key,
    this.ovrlinklabel,
  ...
  @override
  _BreadcrumbsElementsTextIconCenterSeparatorHover createState() =>
      _BreadcrumbsElementsTextIconCenterSeparatorHover();
}

class _BreadcrumbsElementsTextIconCenterSeparatorHover
    extends State<BreadcrumbsElementsTextIconCenterSeparatorHover> {
  _BreadcrumbsElementsTextIconCenterSeparatorHover();
