...
class ButtonOutlinedErrorRightIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonOutlinedErrorRightIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedErrorRightIconHover createState() =>
      _ButtonOutlinedErrorRightIconHover();
}

class _ButtonOutlinedErrorRightIconHover
    extends State<ButtonOutlinedErrorRightIconHover> {
  _ButtonOutlinedErrorRightIconHover();
