...
class NotificationExampleTitleTextSuccess extends StatefulWidget {
  ...
  const NotificationExampleTitleTextSuccess(
    this.constraints, {
    Key? key,
  ...
  @override
  _NotificationExampleTitleTextSuccess createState() =>
      _NotificationExampleTitleTextSuccess();
}

class _NotificationExampleTitleTextSuccess
    extends State<NotificationExampleTitleTextSuccess> {
  _NotificationExampleTitleTextSuccess();
