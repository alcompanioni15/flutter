...
class CircularButtonFilledGrayPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFilledGrayPressed(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFilledGrayPressed createState() =>
      _CircularButtonFilledGrayPressed();
}

class _CircularButtonFilledGrayPressed
    extends State<CircularButtonFilledGrayPressed> {
  _CircularButtonFilledGrayPressed();
