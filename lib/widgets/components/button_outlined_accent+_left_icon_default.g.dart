...
class ButtonOutlinedAccentLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedAccentLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedAccentLeftIconDefault createState() =>
      _ButtonOutlinedAccentLeftIconDefault();
}

class _ButtonOutlinedAccentLeftIconDefault
    extends State<ButtonOutlinedAccentLeftIconDefault> {
  _ButtonOutlinedAccentLeftIconDefault();
