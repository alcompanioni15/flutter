...
class ButtonTextAccentRightIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextAccentRightIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextAccentRightIconPressed createState() =>
      _ButtonTextAccentRightIconPressed();
}

class _ButtonTextAccentRightIconPressed
    extends State<ButtonTextAccentRightIconPressed> {
  _ButtonTextAccentRightIconPressed();
