...
class ControlsCheckboxOnlyCheckedDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovriconoutlinedsuggestedsymbolcheck;
  const ControlsCheckboxOnlyCheckedDisabled(
    this.constraints, {
    Key? key,
    this.ovriconoutlinedsuggestedsymbolcheck,
  }) : super(key: key);
  @override
  _ControlsCheckboxOnlyCheckedDisabled createState() =>
      _ControlsCheckboxOnlyCheckedDisabled();
}

class _ControlsCheckboxOnlyCheckedDisabled
    extends State<ControlsCheckboxOnlyCheckedDisabled> {
  _ControlsCheckboxOnlyCheckedDisabled();
