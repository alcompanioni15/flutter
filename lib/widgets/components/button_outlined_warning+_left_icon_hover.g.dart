...
class ButtonOutlinedWarningLeftIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonOutlinedWarningLeftIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedWarningLeftIconHover createState() =>
      _ButtonOutlinedWarningLeftIconHover();
}

class _ButtonOutlinedWarningLeftIconHover
    extends State<ButtonOutlinedWarningLeftIconHover> {
  _ButtonOutlinedWarningLeftIconHover();
