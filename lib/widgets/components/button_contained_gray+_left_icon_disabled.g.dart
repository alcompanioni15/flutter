...
class ButtonContainedGrayLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedGrayLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedGrayLeftIconDisabled createState() =>
      _ButtonContainedGrayLeftIconDisabled();
}

class _ButtonContainedGrayLeftIconDisabled
    extends State<ButtonContainedGrayLeftIconDisabled> {
  _ButtonContainedGrayLeftIconDisabled();
