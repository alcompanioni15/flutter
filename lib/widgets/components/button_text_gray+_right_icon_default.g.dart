...
class ButtonTextGrayRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextGrayRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextGrayRightIconDefault createState() =>
      _ButtonTextGrayRightIconDefault();
}

class _ButtonTextGrayRightIconDefault
    extends State<ButtonTextGrayRightIconDefault> {
  _ButtonTextGrayRightIconDefault();
