...
class ButtonContainedErrorLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedErrorLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedErrorLeftIconDisabled createState() =>
      _ButtonContainedErrorLeftIconDisabled();
}

class _ButtonContainedErrorLeftIconDisabled
    extends State<ButtonContainedErrorLeftIconDisabled> {
  _ButtonContainedErrorLeftIconDisabled();
