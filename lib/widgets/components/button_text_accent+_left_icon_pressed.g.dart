...
class ButtonTextAccentLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextAccentLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextAccentLeftIconPressed createState() =>
      _ButtonTextAccentLeftIconPressed();
}

class _ButtonTextAccentLeftIconPressed
    extends State<ButtonTextAccentLeftIconPressed> {
  _ButtonTextAccentLeftIconPressed();
