...
class CircularButtonFilledErrorPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFilledErrorPressed(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFilledErrorPressed createState() =>
      _CircularButtonFilledErrorPressed();
}

class _CircularButtonFilledErrorPressed
    extends State<CircularButtonFilledErrorPressed> {
  _CircularButtonFilledErrorPressed();
