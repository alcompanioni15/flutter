...
class ButtonOutlinedGrayRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedGrayRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedGrayRightIconDefault createState() =>
      _ButtonOutlinedGrayRightIconDefault();
}

class _ButtonOutlinedGrayRightIconDefault
    extends State<ButtonOutlinedGrayRightIconDefault> {
  _ButtonOutlinedGrayRightIconDefault();
