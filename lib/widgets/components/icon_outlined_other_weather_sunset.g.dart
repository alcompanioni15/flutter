...
class IconOutlinedOtherWeatherSunset extends StatefulWidget {
  ...
  const IconOutlinedOtherWeatherSunset(
    this.constraints, {
    Key? key,
    this.ovrVector,
    this.ovrVector2,
  ...
  @override
  _IconOutlinedOtherWeatherSunset createState() =>
      _IconOutlinedOtherWeatherSunset();
}

class _IconOutlinedOtherWeatherSunset
    extends State<IconOutlinedOtherWeatherSunset> {
  _IconOutlinedOtherWeatherSunset();
