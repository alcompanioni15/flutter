...
class ChipsOutlinedAvatarSelected extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovravatarcircledwoman01;
  final String? ovrChiplabel;
  const ChipsOutlinedAvatarSelected(
    this.constraints, {
    Key? key,
  ...
  @override
  _ChipsOutlinedAvatarSelected createState() => _ChipsOutlinedAvatarSelected();
}

class _ChipsOutlinedAvatarSelected extends State<ChipsOutlinedAvatarSelected> {
  _ChipsOutlinedAvatarSelected();
