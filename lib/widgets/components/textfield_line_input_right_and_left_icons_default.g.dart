...
class TextfieldLineInputRightAndLeftIconsDefault extends StatefulWidget {
  ...
  const TextfieldLineInputRightAndLeftIconsDefault(
    this.constraints, {
    Key? key,
    this.ovrPlaceholder,
  ...
  @override
  _TextfieldLineInputRightAndLeftIconsDefault createState() =>
      _TextfieldLineInputRightAndLeftIconsDefault();
}

class _TextfieldLineInputRightAndLeftIconsDefault
    extends State<TextfieldLineInputRightAndLeftIconsDefault> {
  _TextfieldLineInputRightAndLeftIconsDefault();
