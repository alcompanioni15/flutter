...
class NavigationMenuverticalElementsItemLeftIconCleanHover
    extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrCursorPointinghand;
  final Widget? ovriconoutlinedothermailarchive;
  final String? ovrlabel;
  const NavigationMenuverticalElementsItemLeftIconCleanHover(
    this.constraints, {
    Key? key,
  ...
  @override
  _NavigationMenuverticalElementsItemLeftIconCleanHover createState() =>
      _NavigationMenuverticalElementsItemLeftIconCleanHover();
}

class _NavigationMenuverticalElementsItemLeftIconCleanHover
    extends State<NavigationMenuverticalElementsItemLeftIconCleanHover> {
  _NavigationMenuverticalElementsItemLeftIconCleanHover();
