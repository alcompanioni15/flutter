...
class TextfieldContainedInputRightAndLeftIconsFilled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrPlace;
  final Widget? ovriconoutlinedsuggestedsymbolx;
  final Widget? ovriconoutlinedactionmainsearch;
  final String? ovrLabel;
  const TextfieldContainedInputRightAndLeftIconsFilled(
    this.constraints, {
    Key? key,
    this.ovrPlace,
  ...
  @override
  _TextfieldContainedInputRightAndLeftIconsFilled createState() =>
      _TextfieldContainedInputRightAndLeftIconsFilled();
}

class _TextfieldContainedInputRightAndLeftIconsFilled
    extends State<TextfieldContainedInputRightAndLeftIconsFilled> {
  _TextfieldContainedInputRightAndLeftIconsFilled();
