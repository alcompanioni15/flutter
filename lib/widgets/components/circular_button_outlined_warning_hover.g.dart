...
class CircularButtonOutlinedWarningHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  final Widget? ovrCursorPointinghand;
  const CircularButtonOutlinedWarningHover(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedWarningHover createState() =>
      _CircularButtonOutlinedWarningHover();
}

class _CircularButtonOutlinedWarningHover
    extends State<CircularButtonOutlinedWarningHover> {
  _CircularButtonOutlinedWarningHover();
