...
class ButtonOutlinedGrayLeftIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonOutlinedGrayLeftIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedGrayLeftIconHover createState() =>
      _ButtonOutlinedGrayLeftIconHover();
}

class _ButtonOutlinedGrayLeftIconHover
    extends State<ButtonOutlinedGrayLeftIconHover> {
  _ButtonOutlinedGrayLeftIconHover();
