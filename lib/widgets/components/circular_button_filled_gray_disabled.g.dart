...
class CircularButtonFilledGrayDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFilledGrayDisabled(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFilledGrayDisabled createState() =>
      _CircularButtonFilledGrayDisabled();
}

class _CircularButtonFilledGrayDisabled
    extends State<CircularButtonFilledGrayDisabled> {
  _CircularButtonFilledGrayDisabled();
