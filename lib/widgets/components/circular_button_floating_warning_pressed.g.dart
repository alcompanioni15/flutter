...
class CircularButtonFloatingWarningPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFloatingWarningPressed(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingWarningPressed createState() =>
      _CircularButtonFloatingWarningPressed();
}

class _CircularButtonFloatingWarningPressed
    extends State<CircularButtonFloatingWarningPressed> {
  _CircularButtonFloatingWarningPressed();
