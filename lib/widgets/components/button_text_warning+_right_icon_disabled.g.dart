...
class ButtonTextWarningRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextWarningRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextWarningRightIconDisabled createState() =>
      _ButtonTextWarningRightIconDisabled();
}

class _ButtonTextWarningRightIconDisabled
    extends State<ButtonTextWarningRightIconDisabled> {
  _ButtonTextWarningRightIconDisabled();
