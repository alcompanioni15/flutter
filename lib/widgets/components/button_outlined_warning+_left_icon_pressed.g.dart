...
class ButtonOutlinedWarningLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedWarningLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedWarningLeftIconPressed createState() =>
      _ButtonOutlinedWarningLeftIconPressed();
}

class _ButtonOutlinedWarningLeftIconPressed
    extends State<ButtonOutlinedWarningLeftIconPressed> {
  _ButtonOutlinedWarningLeftIconPressed();
