...
class ButtonOutlinedGrayLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedGrayLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedGrayLeftIconPressed createState() =>
      _ButtonOutlinedGrayLeftIconPressed();
}

class _ButtonOutlinedGrayLeftIconPressed
    extends State<ButtonOutlinedGrayLeftIconPressed> {
  _ButtonOutlinedGrayLeftIconPressed();
