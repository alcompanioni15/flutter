...
class ButtonOutlinedAccentLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedAccentLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedAccentLeftIconDisabled createState() =>
      _ButtonOutlinedAccentLeftIconDisabled();
}

class _ButtonOutlinedAccentLeftIconDisabled
    extends State<ButtonOutlinedAccentLeftIconDisabled> {
  _ButtonOutlinedAccentLeftIconDisabled();
