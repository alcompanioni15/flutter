...
class TextfieldLineInputLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrPlaceholder;
  final Widget? ovriconoutlinedothermailmail;
  const TextfieldLineInputLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrPlaceholder,
  ...
  @override
  _TextfieldLineInputLeftIconDefault createState() =>
      _TextfieldLineInputLeftIconDefault();
}

class _TextfieldLineInputLeftIconDefault
    extends State<TextfieldLineInputLeftIconDefault> {
  _TextfieldLineInputLeftIconDefault();
