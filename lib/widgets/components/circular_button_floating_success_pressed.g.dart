...
class CircularButtonFloatingSuccessPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFloatingSuccessPressed(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingSuccessPressed createState() =>
      _CircularButtonFloatingSuccessPressed();
}

class _CircularButtonFloatingSuccessPressed
    extends State<CircularButtonFloatingSuccessPressed> {
  _CircularButtonFloatingSuccessPressed();
