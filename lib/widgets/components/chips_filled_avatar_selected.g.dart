...
class ChipsFilledAvatarSelected extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovravatarcircledwoman01;
  final String? ovrChiplabel;
  const ChipsFilledAvatarSelected(
    this.constraints, {
    Key? key,
  ...
  @override
  _ChipsFilledAvatarSelected createState() => _ChipsFilledAvatarSelected();
}

class _ChipsFilledAvatarSelected extends State<ChipsFilledAvatarSelected> {
  _ChipsFilledAvatarSelected();
