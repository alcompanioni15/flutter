...
class CircularButtonFloatingErrorPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFloatingErrorPressed(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingErrorPressed createState() =>
      _CircularButtonFloatingErrorPressed();
}

class _CircularButtonFloatingErrorPressed
    extends State<CircularButtonFloatingErrorPressed> {
  _CircularButtonFloatingErrorPressed();
