...
class ButtonContainedErrorLeftIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonContainedErrorLeftIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedErrorLeftIconHover createState() =>
      _ButtonContainedErrorLeftIconHover();
}

class _ButtonContainedErrorLeftIconHover
    extends State<ButtonContainedErrorLeftIconHover> {
  _ButtonContainedErrorLeftIconHover();
