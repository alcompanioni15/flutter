...
class ChipsFilledClearOptionPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrChiplabel;
  final Widget? ovriconoutlinedsuggestedcirclex;
  const ChipsFilledClearOptionPressed(
    this.constraints, {
    Key? key,
    this.ovrChiplabel,
  ...
  @override
  _ChipsFilledClearOptionPressed createState() =>
      _ChipsFilledClearOptionPressed();
}

class _ChipsFilledClearOptionPressed
    extends State<ChipsFilledClearOptionPressed> {
  _ChipsFilledClearOptionPressed();
