...
class CommentElementsLikeDislikeLikeHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovriconoutlinedactionthumbthumbup;
  final String? ovr0;
  final Widget? ovrCursorPointinghand;
  const CommentElementsLikeDislikeLikeHover(
    this.constraints, {
    Key? key,
  ...
  @override
  _CommentElementsLikeDislikeLikeHover createState() =>
      _CommentElementsLikeDislikeLikeHover();
}

class _CommentElementsLikeDislikeLikeHover
    extends State<CommentElementsLikeDislikeLikeHover> {
  _CommentElementsLikeDislikeLikeHover();
