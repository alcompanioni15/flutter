...
class ButtonOutlinedSuccessLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedSuccessLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedSuccessLeftIconPressed createState() =>
      _ButtonOutlinedSuccessLeftIconPressed();
}

class _ButtonOutlinedSuccessLeftIconPressed
    extends State<ButtonOutlinedSuccessLeftIconPressed> {
  _ButtonOutlinedSuccessLeftIconPressed();
