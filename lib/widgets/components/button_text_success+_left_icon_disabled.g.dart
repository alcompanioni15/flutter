...
class ButtonTextSuccessLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextSuccessLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextSuccessLeftIconDisabled createState() =>
      _ButtonTextSuccessLeftIconDisabled();
}

class _ButtonTextSuccessLeftIconDisabled
    extends State<ButtonTextSuccessLeftIconDisabled> {
  _ButtonTextSuccessLeftIconDisabled();
