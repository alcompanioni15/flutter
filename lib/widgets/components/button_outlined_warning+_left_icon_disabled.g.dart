...
class ButtonOutlinedWarningLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedWarningLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedWarningLeftIconDisabled createState() =>
      _ButtonOutlinedWarningLeftIconDisabled();
}

class _ButtonOutlinedWarningLeftIconDisabled
    extends State<ButtonOutlinedWarningLeftIconDisabled> {
  _ButtonOutlinedWarningLeftIconDisabled();
