...
class UploadAttachmentCardDefault extends StatefulWidget {
  ...
  @override
  _UploadAttachmentCardDefault createState() => _UploadAttachmentCardDefault();
}

class _UploadAttachmentCardDefault extends State<UploadAttachmentCardDefault> {
  _UploadAttachmentCardDefault();
