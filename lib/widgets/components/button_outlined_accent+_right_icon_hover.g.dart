...
class ButtonOutlinedAccentRightIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonOutlinedAccentRightIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedAccentRightIconHover createState() =>
      _ButtonOutlinedAccentRightIconHover();
}

class _ButtonOutlinedAccentRightIconHover
    extends State<ButtonOutlinedAccentRightIconHover> {
  _ButtonOutlinedAccentRightIconHover();
