...
class BadgeSingleIconAccent extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrbadge;
  final Widget? ovriconoutlinedactionmainclock;
  const BadgeSingleIconAccent(
    this.constraints, {
    Key? key,
    this.ovrbadge,
  ...
  @override
  _BadgeSingleIconAccent createState() => _BadgeSingleIconAccent();
}

class _BadgeSingleIconAccent extends State<BadgeSingleIconAccent> {
  _BadgeSingleIconAccent();
