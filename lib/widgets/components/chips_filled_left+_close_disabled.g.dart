...
class ChipsFilledLeftCloseDisabled extends StatefulWidget {
  ...
  const ChipsFilledLeftCloseDisabled(
    this.constraints, {
    Key? key,
    this.ovrChiplabel,
  ...
  @override
  _ChipsFilledLeftCloseDisabled createState() =>
      _ChipsFilledLeftCloseDisabled();
}

class _ChipsFilledLeftCloseDisabled
    extends State<ChipsFilledLeftCloseDisabled> {
  _ChipsFilledLeftCloseDisabled();
