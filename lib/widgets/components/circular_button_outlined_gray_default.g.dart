...
class CircularButtonOutlinedGrayDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonOutlinedGrayDefault(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedGrayDefault createState() =>
      _CircularButtonOutlinedGrayDefault();
}

class _CircularButtonOutlinedGrayDefault
    extends State<CircularButtonOutlinedGrayDefault> {
  _CircularButtonOutlinedGrayDefault();
