...
class TextfieldLineInputRightAndLeftIconsFilled extends StatefulWidget {
  ...
  const TextfieldLineInputRightAndLeftIconsFilled(
    this.constraints, {
    Key? key,
    this.ovrPlaceholder,
  ...
  @override
  _TextfieldLineInputRightAndLeftIconsFilled createState() =>
      _TextfieldLineInputRightAndLeftIconsFilled();
}

class _TextfieldLineInputRightAndLeftIconsFilled
    extends State<TextfieldLineInputRightAndLeftIconsFilled> {
  _TextfieldLineInputRightAndLeftIconsFilled();
