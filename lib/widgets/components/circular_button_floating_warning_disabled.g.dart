...
class CircularButtonFloatingWarningDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFloatingWarningDisabled(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingWarningDisabled createState() =>
      _CircularButtonFloatingWarningDisabled();
}

class _CircularButtonFloatingWarningDisabled
    extends State<CircularButtonFloatingWarningDisabled> {
  _CircularButtonFloatingWarningDisabled();
