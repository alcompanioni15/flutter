...
class ChipsOutlinedLeftClosePressed extends StatefulWidget {
  ...
  const ChipsOutlinedLeftClosePressed(
    this.constraints, {
    Key? key,
    this.ovrChiplabel,
  ...
  @override
  _ChipsOutlinedLeftClosePressed createState() =>
      _ChipsOutlinedLeftClosePressed();
}

class _ChipsOutlinedLeftClosePressed
    extends State<ChipsOutlinedLeftClosePressed> {
  _ChipsOutlinedLeftClosePressed();
