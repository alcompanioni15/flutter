...
class ButtonOutlinedErrorLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedErrorLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedErrorLeftIconPressed createState() =>
      _ButtonOutlinedErrorLeftIconPressed();
}

class _ButtonOutlinedErrorLeftIconPressed
    extends State<ButtonOutlinedErrorLeftIconPressed> {
  _ButtonOutlinedErrorLeftIconPressed();
