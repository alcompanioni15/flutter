...
class ButtonTextGrayLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextGrayLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextGrayLeftIconDefault createState() =>
      _ButtonTextGrayLeftIconDefault();
}

class _ButtonTextGrayLeftIconDefault
    extends State<ButtonTextGrayLeftIconDefault> {
  _ButtonTextGrayLeftIconDefault();
