...
class TextfieldContainedInputLeftIconFocused extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrPlaceholder;
  final Widget? ovriconoutlinedothermailmail;
  final String? ovrLabel;
  const TextfieldContainedInputLeftIconFocused(
    this.constraints, {
    Key? key,
    this.ovrPlaceholder,
  ...
  @override
  _TextfieldContainedInputLeftIconFocused createState() =>
      _TextfieldContainedInputLeftIconFocused();
}

class _TextfieldContainedInputLeftIconFocused
    extends State<TextfieldContainedInputLeftIconFocused> {
  _TextfieldContainedInputLeftIconFocused();
