...
class NotificationExampleTitleTextClosableWhite extends StatefulWidget {
  ...
  const NotificationExampleTitleTextClosableWhite(
    this.constraints, {
    Key? key,
  ...
  @override
  _NotificationExampleTitleTextClosableWhite createState() =>
      _NotificationExampleTitleTextClosableWhite();
}

class _NotificationExampleTitleTextClosableWhite
    extends State<NotificationExampleTitleTextClosableWhite> {
  _NotificationExampleTitleTextClosableWhite();
