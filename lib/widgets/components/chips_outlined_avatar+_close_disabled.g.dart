...
class ChipsOutlinedAvatarCloseDisabled extends StatefulWidget {
  ...
  @override
  _ChipsOutlinedAvatarCloseDisabled createState() =>
      _ChipsOutlinedAvatarCloseDisabled();
}

class _ChipsOutlinedAvatarCloseDisabled
    extends State<ChipsOutlinedAvatarCloseDisabled> {
  _ChipsOutlinedAvatarCloseDisabled();
