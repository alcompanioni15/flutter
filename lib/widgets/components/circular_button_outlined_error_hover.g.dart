...
class CircularButtonOutlinedErrorHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  final Widget? ovrCursorPointinghand;
  const CircularButtonOutlinedErrorHover(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedErrorHover createState() =>
      _CircularButtonOutlinedErrorHover();
}

class _CircularButtonOutlinedErrorHover
    extends State<CircularButtonOutlinedErrorHover> {
  _CircularButtonOutlinedErrorHover();
