...
class NotificationExampleTextualGray extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrnotificationelementssurfacegray;
  final String? ovrGraytext;
  const NotificationExampleTextualGray(
    this.constraints, {
    Key? key,
  ...
  @override
  _NotificationExampleTextualGray createState() =>
      _NotificationExampleTextualGray();
}

class _NotificationExampleTextualGray
    extends State<NotificationExampleTextualGray> {
  _NotificationExampleTextualGray();
