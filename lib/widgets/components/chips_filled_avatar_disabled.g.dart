...
class ChipsFilledAvatarDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovravatarcircledwoman01;
  final String? ovrChiplabel;
  const ChipsFilledAvatarDisabled(
    this.constraints, {
    Key? key,
  ...
  @override
  _ChipsFilledAvatarDisabled createState() => _ChipsFilledAvatarDisabled();
}

class _ChipsFilledAvatarDisabled extends State<ChipsFilledAvatarDisabled> {
  _ChipsFilledAvatarDisabled();
