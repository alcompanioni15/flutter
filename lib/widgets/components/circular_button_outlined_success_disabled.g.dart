...
class CircularButtonOutlinedSuccessDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonOutlinedSuccessDisabled(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedSuccessDisabled createState() =>
      _CircularButtonOutlinedSuccessDisabled();
}

class _CircularButtonOutlinedSuccessDisabled
    extends State<CircularButtonOutlinedSuccessDisabled> {
  _CircularButtonOutlinedSuccessDisabled();
