...
class ChipsFilledAvatarClosePressed extends StatefulWidget {
  ...
  @override
  _ChipsFilledAvatarClosePressed createState() =>
      _ChipsFilledAvatarClosePressed();
}

class _ChipsFilledAvatarClosePressed
    extends State<ChipsFilledAvatarClosePressed> {
  _ChipsFilledAvatarClosePressed();
