...
class ButtonOutlinedAccentLeftIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonOutlinedAccentLeftIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedAccentLeftIconHover createState() =>
      _ButtonOutlinedAccentLeftIconHover();
}

class _ButtonOutlinedAccentLeftIconHover
    extends State<ButtonOutlinedAccentLeftIconHover> {
  _ButtonOutlinedAccentLeftIconHover();
