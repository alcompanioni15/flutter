...
class CircularButtonOutlinedWarningDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonOutlinedWarningDisabled(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedWarningDisabled createState() =>
      _CircularButtonOutlinedWarningDisabled();
}

class _CircularButtonOutlinedWarningDisabled
    extends State<CircularButtonOutlinedWarningDisabled> {
  _CircularButtonOutlinedWarningDisabled();
