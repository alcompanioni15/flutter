...
class CircularButtonOutlinedGrayDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonOutlinedGrayDisabled(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedGrayDisabled createState() =>
      _CircularButtonOutlinedGrayDisabled();
}

class _CircularButtonOutlinedGrayDisabled
    extends State<CircularButtonOutlinedGrayDisabled> {
  _CircularButtonOutlinedGrayDisabled();
