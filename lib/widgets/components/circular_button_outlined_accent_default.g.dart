...
class CircularButtonOutlinedAccentDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonOutlinedAccentDefault(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedAccentDefault createState() =>
      _CircularButtonOutlinedAccentDefault();
}

class _CircularButtonOutlinedAccentDefault
    extends State<CircularButtonOutlinedAccentDefault> {
  _CircularButtonOutlinedAccentDefault();
