...
class DropdownMenuUserDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrlabel;
  final Widget? ovravatarcircledman01;
  const DropdownMenuUserDisabled(
    this.constraints, {
    Key? key,
    this.ovrlabel,
  ...
  @override
  _DropdownMenuUserDisabled createState() => _DropdownMenuUserDisabled();
}

class _DropdownMenuUserDisabled extends State<DropdownMenuUserDisabled> {
  _DropdownMenuUserDisabled();
