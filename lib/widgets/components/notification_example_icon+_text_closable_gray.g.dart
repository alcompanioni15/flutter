...
class NotificationExampleIconTextClosableGray extends StatefulWidget {
  ...
  const NotificationExampleIconTextClosableGray(
    this.constraints, {
    Key? key,
  ...
  @override
  _NotificationExampleIconTextClosableGray createState() =>
      _NotificationExampleIconTextClosableGray();
}

class _NotificationExampleIconTextClosableGray
    extends State<NotificationExampleIconTextClosableGray> {
  _NotificationExampleIconTextClosableGray();
