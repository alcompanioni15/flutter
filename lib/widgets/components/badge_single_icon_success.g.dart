...
class BadgeSingleIconSuccess extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrbadge;
  final Widget? ovriconoutlinedactionmainclock;
  const BadgeSingleIconSuccess(
    this.constraints, {
    Key? key,
    this.ovrbadge,
  ...
  @override
  _BadgeSingleIconSuccess createState() => _BadgeSingleIconSuccess();
}

class _BadgeSingleIconSuccess extends State<BadgeSingleIconSuccess> {
  _BadgeSingleIconSuccess();
