...
class ChipsOutlinedAvatarCloseDefault extends StatefulWidget {
  ...
  @override
  _ChipsOutlinedAvatarCloseDefault createState() =>
      _ChipsOutlinedAvatarCloseDefault();
}

class _ChipsOutlinedAvatarCloseDefault
    extends State<ChipsOutlinedAvatarCloseDefault> {
  _ChipsOutlinedAvatarCloseDefault();
