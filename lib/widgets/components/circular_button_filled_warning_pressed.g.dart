...
class CircularButtonFilledWarningPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFilledWarningPressed(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFilledWarningPressed createState() =>
      _CircularButtonFilledWarningPressed();
}

class _CircularButtonFilledWarningPressed
    extends State<CircularButtonFilledWarningPressed> {
  _CircularButtonFilledWarningPressed();
