...
class ButtonContainedGrayLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedGrayLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedGrayLeftIconDefault createState() =>
      _ButtonContainedGrayLeftIconDefault();
}

class _ButtonContainedGrayLeftIconDefault
    extends State<ButtonContainedGrayLeftIconDefault> {
  _ButtonContainedGrayLeftIconDefault();
