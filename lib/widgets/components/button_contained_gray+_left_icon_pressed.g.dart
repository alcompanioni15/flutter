...
class ButtonContainedGrayLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedGrayLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedGrayLeftIconPressed createState() =>
      _ButtonContainedGrayLeftIconPressed();
}

class _ButtonContainedGrayLeftIconPressed
    extends State<ButtonContainedGrayLeftIconPressed> {
  _ButtonContainedGrayLeftIconPressed();
