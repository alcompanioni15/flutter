...
class ButtonTextSuccessLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextSuccessLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextSuccessLeftIconPressed createState() =>
      _ButtonTextSuccessLeftIconPressed();
}

class _ButtonTextSuccessLeftIconPressed
    extends State<ButtonTextSuccessLeftIconPressed> {
  _ButtonTextSuccessLeftIconPressed();
