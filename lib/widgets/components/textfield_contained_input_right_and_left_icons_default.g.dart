...
class TextfieldContainedInputRightAndLeftIconsDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrPlace;
  final Widget? ovriconoutlinedsuggestedsymbolx;
  final Widget? ovriconoutlinedactionmainsearch;
  final String? ovrLabel;
  const TextfieldContainedInputRightAndLeftIconsDefault(
    this.constraints, {
    Key? key,
    this.ovrPlace,
  ...
  @override
  _TextfieldContainedInputRightAndLeftIconsDefault createState() =>
      _TextfieldContainedInputRightAndLeftIconsDefault();
}

class _TextfieldContainedInputRightAndLeftIconsDefault
    extends State<TextfieldContainedInputRightAndLeftIconsDefault> {
  _TextfieldContainedInputRightAndLeftIconsDefault();
