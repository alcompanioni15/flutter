...
class NotificationExampleTitleTextClosableWarning extends StatefulWidget {
  ...
  const NotificationExampleTitleTextClosableWarning(
    this.constraints, {
    Key? key,
  ...
  @override
  _NotificationExampleTitleTextClosableWarning createState() =>
      _NotificationExampleTitleTextClosableWarning();
}

class _NotificationExampleTitleTextClosableWarning
    extends State<NotificationExampleTitleTextClosableWarning> {
  _NotificationExampleTitleTextClosableWarning();
