...
class ChartsExampleDonutChartStrokeDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrchartselementsdonutchartstroke100;
  final Widget? ovrchartselementsdonutchartstroke75;
  const ChartsExampleDonutChartStrokeDefault(
    this.constraints, {
    Key? key,
  ...
  @override
  _ChartsExampleDonutChartStrokeDefault createState() =>
      _ChartsExampleDonutChartStrokeDefault();
}

class _ChartsExampleDonutChartStrokeDefault
    extends State<ChartsExampleDonutChartStrokeDefault> {
  _ChartsExampleDonutChartStrokeDefault();
