...
class ChipsOutlinedAvatarDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovravatarcircledwoman01;
  final String? ovrChiplabel;
  const ChipsOutlinedAvatarDisabled(
    this.constraints, {
    Key? key,
  ...
  @override
  _ChipsOutlinedAvatarDisabled createState() => _ChipsOutlinedAvatarDisabled();
}

class _ChipsOutlinedAvatarDisabled extends State<ChipsOutlinedAvatarDisabled> {
  _ChipsOutlinedAvatarDisabled();
