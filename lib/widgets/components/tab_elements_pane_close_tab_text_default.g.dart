...
class TabElementsPaneCloseTabTextDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrtabelementspointerpaneinactive;
  final Widget? ovriconoutlinedsuggestedsymbolx;
  final String? ovrlabel;
  const TabElementsPaneCloseTabTextDefault(
    this.constraints, {
    Key? key,
  ...
  @override
  _TabElementsPaneCloseTabTextDefault createState() =>
      _TabElementsPaneCloseTabTextDefault();
}

class _TabElementsPaneCloseTabTextDefault
    extends State<TabElementsPaneCloseTabTextDefault> {
  _TabElementsPaneCloseTabTextDefault();
