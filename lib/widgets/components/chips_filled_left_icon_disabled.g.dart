...
class ChipsFilledLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrChiplabel;
  final Widget? ovriconoutlinedotherlocationmappin;
  const ChipsFilledLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrChiplabel,
  ...
  @override
  _ChipsFilledLeftIconDisabled createState() => _ChipsFilledLeftIconDisabled();
}

class _ChipsFilledLeftIconDisabled extends State<ChipsFilledLeftIconDisabled> {
  _ChipsFilledLeftIconDisabled();
