...
class CircularButtonFloatingErrorHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  final Widget? ovrCursorPointinghand;
  const CircularButtonFloatingErrorHover(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingErrorHover createState() =>
      _CircularButtonFloatingErrorHover();
}

class _CircularButtonFloatingErrorHover
    extends State<CircularButtonFloatingErrorHover> {
  _CircularButtonFloatingErrorHover();
