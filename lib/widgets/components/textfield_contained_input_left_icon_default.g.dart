...
class TextfieldContainedInputLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrPlaceholder;
  final Widget? ovriconoutlinedothermailmail;
  final String? ovrLabel;
  const TextfieldContainedInputLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrPlaceholder,
  ...
  @override
  _TextfieldContainedInputLeftIconDefault createState() =>
      _TextfieldContainedInputLeftIconDefault();
}

class _TextfieldContainedInputLeftIconDefault
    extends State<TextfieldContainedInputLeftIconDefault> {
  _TextfieldContainedInputLeftIconDefault();
