...
class NotificationExampleIconTextSuccess extends StatefulWidget {
  ...
  const NotificationExampleIconTextSuccess(
    this.constraints, {
    Key? key,
  ...
  @override
  _NotificationExampleIconTextSuccess createState() =>
      _NotificationExampleIconTextSuccess();
}

class _NotificationExampleIconTextSuccess
    extends State<NotificationExampleIconTextSuccess> {
  _NotificationExampleIconTextSuccess();
