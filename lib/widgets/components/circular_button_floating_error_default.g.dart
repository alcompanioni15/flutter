...
class CircularButtonFloatingErrorDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFloatingErrorDefault(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingErrorDefault createState() =>
      _CircularButtonFloatingErrorDefault();
}

class _CircularButtonFloatingErrorDefault
    extends State<CircularButtonFloatingErrorDefault> {
  _CircularButtonFloatingErrorDefault();
