...
class ChipsFilledLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovriconoutlinedotherlocationmappin;
  final String? ovrChiplabel;
  const ChipsFilledLeftIconDefault(
    this.constraints, {
    Key? key,
  ...
  @override
  _ChipsFilledLeftIconDefault createState() => _ChipsFilledLeftIconDefault();
}

class _ChipsFilledLeftIconDefault extends State<ChipsFilledLeftIconDefault> {
  _ChipsFilledLeftIconDefault();
