...
class ButtonOutlinedGrayRightIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedGrayRightIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedGrayRightIconPressed createState() =>
      _ButtonOutlinedGrayRightIconPressed();
}

class _ButtonOutlinedGrayRightIconPressed
    extends State<ButtonOutlinedGrayRightIconPressed> {
  _ButtonOutlinedGrayRightIconPressed();
