...
class DropdownMenuUserInfoDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrlabel;
  final String? ovrinfo;
  final Widget? ovravatarcircledman01;
  const DropdownMenuUserInfoDefault(
    this.constraints, {
    Key? key,
    this.ovrlabel,
    this.ovrinfo,
  ...
  @override
  _DropdownMenuUserInfoDefault createState() => _DropdownMenuUserInfoDefault();
}

class _DropdownMenuUserInfoDefault extends State<DropdownMenuUserInfoDefault> {
  _DropdownMenuUserInfoDefault();
