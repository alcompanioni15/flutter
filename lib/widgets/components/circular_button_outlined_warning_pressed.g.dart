...
class CircularButtonOutlinedWarningPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonOutlinedWarningPressed(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedWarningPressed createState() =>
      _CircularButtonOutlinedWarningPressed();
}

class _CircularButtonOutlinedWarningPressed
    extends State<CircularButtonOutlinedWarningPressed> {
  _CircularButtonOutlinedWarningPressed();
