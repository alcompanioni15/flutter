...
class ButtonOutlinedWarningRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedWarningRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedWarningRightIconDefault createState() =>
      _ButtonOutlinedWarningRightIconDefault();
}

class _ButtonOutlinedWarningRightIconDefault
    extends State<ButtonOutlinedWarningRightIconDefault> {
  _ButtonOutlinedWarningRightIconDefault();
