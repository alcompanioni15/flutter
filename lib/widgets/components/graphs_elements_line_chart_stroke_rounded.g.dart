...
class GraphsElementsLineChartStrokeRounded extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrlinechart;
  const GraphsElementsLineChartStrokeRounded(
    this.constraints, {
    Key? key,
    this.ovrlinechart,
  }) : super(key: key);
  @override
  _GraphsElementsLineChartStrokeRounded createState() =>
      _GraphsElementsLineChartStrokeRounded();
}

class _GraphsElementsLineChartStrokeRounded
    extends State<GraphsElementsLineChartStrokeRounded> {
  _GraphsElementsLineChartStrokeRounded();
