...
class TextfieldContainedInputRightAndLeftIconsDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrPlace;
  final Widget? ovriconoutlinedsuggestedsymbolx;
  final Widget? ovriconoutlinedactionmainsearch;
  final String? ovrLabel;
  const TextfieldContainedInputRightAndLeftIconsDisabled(
    this.constraints, {
    Key? key,
    this.ovrPlace,
  ...
  @override
  _TextfieldContainedInputRightAndLeftIconsDisabled createState() =>
      _TextfieldContainedInputRightAndLeftIconsDisabled();
}

class _TextfieldContainedInputRightAndLeftIconsDisabled
    extends State<TextfieldContainedInputRightAndLeftIconsDisabled> {
  _TextfieldContainedInputRightAndLeftIconsDisabled();
