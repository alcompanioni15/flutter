...
class ModalExampleInformationError extends StatefulWidget {
  ...
  const ModalExampleInformationError(
    this.constraints, {
    Key? key,
  ...
  @override
  _ModalExampleInformationError createState() =>
      _ModalExampleInformationError();
}

class _ModalExampleInformationError
    extends State<ModalExampleInformationError> {
  _ModalExampleInformationError();
