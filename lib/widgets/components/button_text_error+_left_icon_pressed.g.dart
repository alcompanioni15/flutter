...
class ButtonTextErrorLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextErrorLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextErrorLeftIconPressed createState() =>
      _ButtonTextErrorLeftIconPressed();
}

class _ButtonTextErrorLeftIconPressed
    extends State<ButtonTextErrorLeftIconPressed> {
  _ButtonTextErrorLeftIconPressed();
