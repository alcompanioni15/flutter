...
class ButtonOutlinedSuccessRightIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedSuccessRightIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedSuccessRightIconPressed createState() =>
      _ButtonOutlinedSuccessRightIconPressed();
}

class _ButtonOutlinedSuccessRightIconPressed
    extends State<ButtonOutlinedSuccessRightIconPressed> {
  _ButtonOutlinedSuccessRightIconPressed();
