...
class CircularButtonFilledWarningDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFilledWarningDefault(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFilledWarningDefault createState() =>
      _CircularButtonFilledWarningDefault();
}

class _CircularButtonFilledWarningDefault
    extends State<CircularButtonFilledWarningDefault> {
  _CircularButtonFilledWarningDefault();
