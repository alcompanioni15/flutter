...
class ChipsOutlinedAvatarHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovravatarcircledwoman01;
  final String? ovrChiplabel;
  final Widget? ovrCursorPointinghand;
  const ChipsOutlinedAvatarHover(
    this.constraints, {
    Key? key,
  ...
  @override
  _ChipsOutlinedAvatarHover createState() => _ChipsOutlinedAvatarHover();
}

class _ChipsOutlinedAvatarHover extends State<ChipsOutlinedAvatarHover> {
  _ChipsOutlinedAvatarHover();
