...
class NotificationExampleIconTextClosableError extends StatefulWidget {
  ...
  const NotificationExampleIconTextClosableError(
    this.constraints, {
    Key? key,
  ...
  @override
  _NotificationExampleIconTextClosableError createState() =>
      _NotificationExampleIconTextClosableError();
}

class _NotificationExampleIconTextClosableError
    extends State<NotificationExampleIconTextClosableError> {
  _NotificationExampleIconTextClosableError();
