...
class ButtonTextGrayLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextGrayLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextGrayLeftIconDisabled createState() =>
      _ButtonTextGrayLeftIconDisabled();
}

class _ButtonTextGrayLeftIconDisabled
    extends State<ButtonTextGrayLeftIconDisabled> {
  _ButtonTextGrayLeftIconDisabled();
