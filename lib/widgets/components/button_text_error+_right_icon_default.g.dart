...
class ButtonTextErrorRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextErrorRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextErrorRightIconDefault createState() =>
      _ButtonTextErrorRightIconDefault();
}

class _ButtonTextErrorRightIconDefault
    extends State<ButtonTextErrorRightIconDefault> {
  _ButtonTextErrorRightIconDefault();
