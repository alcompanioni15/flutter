...
class ButtonContainedAccentRightIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedAccentRightIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedAccentRightIconPressed createState() =>
      _ButtonContainedAccentRightIconPressed();
}

class _ButtonContainedAccentRightIconPressed
    extends State<ButtonContainedAccentRightIconPressed> {
  _ButtonContainedAccentRightIconPressed();
            ...
            child: Stack(children: [
              Positioned(
                ...
                child: Container(
                  ...
                  width: 126.0,
                  decoration: BoxDecoration(
                    color: Color(0xff046eef),
                    borderRadius: BorderRadius.all(Radius.circular(8)),
                    boxShadow: [
                      BoxShadow(
                        color: Color(0x33046eef),
                        spreadRadius: 12,
                        blurRadius: 12,
                        offset: Offset(0, 4),
                      ),
