...
class ButtonTextWarningRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextWarningRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextWarningRightIconDefault createState() =>
      _ButtonTextWarningRightIconDefault();
}

class _ButtonTextWarningRightIconDefault
    extends State<ButtonTextWarningRightIconDefault> {
  _ButtonTextWarningRightIconDefault();
