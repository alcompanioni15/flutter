...
class BadgeSingleIconGray extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrbadge;
  final Widget? ovriconoutlinedactionmainclock;
  const BadgeSingleIconGray(
    this.constraints, {
    Key? key,
    this.ovrbadge,
  ...
  @override
  _BadgeSingleIconGray createState() => _BadgeSingleIconGray();
}

class _BadgeSingleIconGray extends State<BadgeSingleIconGray> {
  _BadgeSingleIconGray();
