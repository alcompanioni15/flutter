...
class NotificationExampleTextualClosableError extends StatefulWidget {
  ...
  const NotificationExampleTextualClosableError(
    this.constraints, {
    Key? key,
  ...
  @override
  _NotificationExampleTextualClosableError createState() =>
      _NotificationExampleTextualClosableError();
}

class _NotificationExampleTextualClosableError
    extends State<NotificationExampleTextualClosableError> {
  _NotificationExampleTextualClosableError();
