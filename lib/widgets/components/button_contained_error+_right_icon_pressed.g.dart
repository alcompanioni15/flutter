...
class ButtonContainedErrorRightIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedErrorRightIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedErrorRightIconPressed createState() =>
      _ButtonContainedErrorRightIconPressed();
}

class _ButtonContainedErrorRightIconPressed
    extends State<ButtonContainedErrorRightIconPressed> {
  _ButtonContainedErrorRightIconPressed();
