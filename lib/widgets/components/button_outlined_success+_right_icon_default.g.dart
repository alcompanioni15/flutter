...
class ButtonOutlinedSuccessRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedSuccessRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedSuccessRightIconDefault createState() =>
      _ButtonOutlinedSuccessRightIconDefault();
}

class _ButtonOutlinedSuccessRightIconDefault
    extends State<ButtonOutlinedSuccessRightIconDefault> {
  _ButtonOutlinedSuccessRightIconDefault();
