...
class CircularButtonFloatingGrayPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFloatingGrayPressed(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingGrayPressed createState() =>
      _CircularButtonFloatingGrayPressed();
}

class _CircularButtonFloatingGrayPressed
    extends State<CircularButtonFloatingGrayPressed> {
  _CircularButtonFloatingGrayPressed();
