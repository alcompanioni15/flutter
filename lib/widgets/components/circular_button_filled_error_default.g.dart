...
class CircularButtonFilledErrorDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFilledErrorDefault(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFilledErrorDefault createState() =>
      _CircularButtonFilledErrorDefault();
}

class _CircularButtonFilledErrorDefault
    extends State<CircularButtonFilledErrorDefault> {
  _CircularButtonFilledErrorDefault();
