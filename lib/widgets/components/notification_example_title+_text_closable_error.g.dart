...
class NotificationExampleTitleTextClosableError extends StatefulWidget {
  ...
  const NotificationExampleTitleTextClosableError(
    this.constraints, {
    Key? key,
  ...
  @override
  _NotificationExampleTitleTextClosableError createState() =>
      _NotificationExampleTitleTextClosableError();
}

class _NotificationExampleTitleTextClosableError
    extends State<NotificationExampleTitleTextClosableError> {
  _NotificationExampleTitleTextClosableError();
