...
class ButtonTextErrorLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextErrorLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextErrorLeftIconDefault createState() =>
      _ButtonTextErrorLeftIconDefault();
}

class _ButtonTextErrorLeftIconDefault
    extends State<ButtonTextErrorLeftIconDefault> {
  _ButtonTextErrorLeftIconDefault();
