...
class NotificationExampleTitleTextClosableGray extends StatefulWidget {
  ...
  const NotificationExampleTitleTextClosableGray(
    this.constraints, {
    Key? key,
  ...
  @override
  _NotificationExampleTitleTextClosableGray createState() =>
      _NotificationExampleTitleTextClosableGray();
}

class _NotificationExampleTitleTextClosableGray
    extends State<NotificationExampleTitleTextClosableGray> {
  _NotificationExampleTitleTextClosableGray();
