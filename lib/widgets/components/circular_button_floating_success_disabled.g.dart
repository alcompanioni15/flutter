...
class CircularButtonFloatingSuccessDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFloatingSuccessDisabled(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingSuccessDisabled createState() =>
      _CircularButtonFloatingSuccessDisabled();
}

class _CircularButtonFloatingSuccessDisabled
    extends State<CircularButtonFloatingSuccessDisabled> {
  _CircularButtonFloatingSuccessDisabled();
