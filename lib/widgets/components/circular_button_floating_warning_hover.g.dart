...
class CircularButtonFloatingWarningHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  final Widget? ovrCursorPointinghand;
  const CircularButtonFloatingWarningHover(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingWarningHover createState() =>
      _CircularButtonFloatingWarningHover();
}

class _CircularButtonFloatingWarningHover
    extends State<CircularButtonFloatingWarningHover> {
  _CircularButtonFloatingWarningHover();
