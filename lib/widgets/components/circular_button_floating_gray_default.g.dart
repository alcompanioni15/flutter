...
class CircularButtonFloatingGrayDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFloatingGrayDefault(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingGrayDefault createState() =>
      _CircularButtonFloatingGrayDefault();
}

class _CircularButtonFloatingGrayDefault
    extends State<CircularButtonFloatingGrayDefault> {
  _CircularButtonFloatingGrayDefault();
