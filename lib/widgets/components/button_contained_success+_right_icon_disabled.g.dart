...
class ButtonContainedSuccessRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedSuccessRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedSuccessRightIconDisabled createState() =>
      _ButtonContainedSuccessRightIconDisabled();
}

class _ButtonContainedSuccessRightIconDisabled
    extends State<ButtonContainedSuccessRightIconDisabled> {
  _ButtonContainedSuccessRightIconDisabled();
