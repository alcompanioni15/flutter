...
class ButtonTextErrorRightIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextErrorRightIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextErrorRightIconPressed createState() =>
      _ButtonTextErrorRightIconPressed();
}

class _ButtonTextErrorRightIconPressed
    extends State<ButtonTextErrorRightIconPressed> {
  _ButtonTextErrorRightIconPressed();
