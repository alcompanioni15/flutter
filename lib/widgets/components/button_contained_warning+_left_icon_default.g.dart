...
class ButtonContainedWarningLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedWarningLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedWarningLeftIconDefault createState() =>
      _ButtonContainedWarningLeftIconDefault();
}

class _ButtonContainedWarningLeftIconDefault
    extends State<ButtonContainedWarningLeftIconDefault> {
  _ButtonContainedWarningLeftIconDefault();
