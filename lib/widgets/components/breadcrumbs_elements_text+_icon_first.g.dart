...
class BreadcrumbsElementsTextIconFirst extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrlinklabel;
  final Widget? ovriconoutlinedotherlocationhome;
  final String? ovrdivider;
  const BreadcrumbsElementsTextIconFirst(
    this.constraints, {
    Key? key,
    this.ovrlinklabel,
  ...
  @override
  _BreadcrumbsElementsTextIconFirst createState() =>
      _BreadcrumbsElementsTextIconFirst();
}

class _BreadcrumbsElementsTextIconFirst
    extends State<BreadcrumbsElementsTextIconFirst> {
  _BreadcrumbsElementsTextIconFirst();
