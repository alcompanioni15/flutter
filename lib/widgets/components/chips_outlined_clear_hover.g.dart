...
class ChipsOutlinedClearHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrChiplabel;
  final Widget? ovriconoutlinedsuggestedcirclex;
  final Widget? ovrCursorPointinghand;
  const ChipsOutlinedClearHover(
    this.constraints, {
    Key? key,
    this.ovrChiplabel,
  ...
  @override
  _ChipsOutlinedClearHover createState() => _ChipsOutlinedClearHover();
}

class _ChipsOutlinedClearHover extends State<ChipsOutlinedClearHover> {
  _ChipsOutlinedClearHover();
