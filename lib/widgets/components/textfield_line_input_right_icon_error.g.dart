...
class TextfieldLineInputRightIconError extends StatefulWidget {
  ...
  @override
  _TextfieldLineInputRightIconError createState() =>
      _TextfieldLineInputRightIconError();
}

class _TextfieldLineInputRightIconError
    extends State<TextfieldLineInputRightIconError> {
  _TextfieldLineInputRightIconError();
