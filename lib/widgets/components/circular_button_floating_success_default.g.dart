...
class CircularButtonFloatingSuccessDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFloatingSuccessDefault(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingSuccessDefault createState() =>
      _CircularButtonFloatingSuccessDefault();
}

class _CircularButtonFloatingSuccessDefault
    extends State<CircularButtonFloatingSuccessDefault> {
  _CircularButtonFloatingSuccessDefault();
