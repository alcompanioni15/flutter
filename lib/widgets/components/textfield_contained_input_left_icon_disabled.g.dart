...
class TextfieldContainedInputLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrPlaceholder;
  final Widget? ovriconoutlinedothermailmail;
  final String? ovrLabel;
  const TextfieldContainedInputLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrPlaceholder,
  ...
  @override
  _TextfieldContainedInputLeftIconDisabled createState() =>
      _TextfieldContainedInputLeftIconDisabled();
}

class _TextfieldContainedInputLeftIconDisabled
    extends State<TextfieldContainedInputLeftIconDisabled> {
  _TextfieldContainedInputLeftIconDisabled();
