...
class NavigationMenuhorizontalElementsItemLeftIconFilledDefault
    extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovriconoutlinedotherlocationhome;
  final String? ovrlabel;
  const NavigationMenuhorizontalElementsItemLeftIconFilledDefault(
    this.constraints, {
    Key? key,
  ...
  @override
  _NavigationMenuhorizontalElementsItemLeftIconFilledDefault createState() =>
      _NavigationMenuhorizontalElementsItemLeftIconFilledDefault();
}

class _NavigationMenuhorizontalElementsItemLeftIconFilledDefault
    extends State<NavigationMenuhorizontalElementsItemLeftIconFilledDefault> {
  _NavigationMenuhorizontalElementsItemLeftIconFilledDefault();
