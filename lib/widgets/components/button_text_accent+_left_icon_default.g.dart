...
class ButtonTextAccentLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextAccentLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextAccentLeftIconDefault createState() =>
      _ButtonTextAccentLeftIconDefault();
}

class _ButtonTextAccentLeftIconDefault
    extends State<ButtonTextAccentLeftIconDefault> {
  _ButtonTextAccentLeftIconDefault();
