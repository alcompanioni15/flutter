...
class ButtonOutlinedSuccessRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedSuccessRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedSuccessRightIconDisabled createState() =>
      _ButtonOutlinedSuccessRightIconDisabled();
}

class _ButtonOutlinedSuccessRightIconDisabled
    extends State<ButtonOutlinedSuccessRightIconDisabled> {
  _ButtonOutlinedSuccessRightIconDisabled();
