...
class ButtonContainedAccentLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedAccentLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedAccentLeftIconPressed createState() =>
      _ButtonContainedAccentLeftIconPressed();
}

class _ButtonContainedAccentLeftIconPressed
    extends State<ButtonContainedAccentLeftIconPressed> {
  _ButtonContainedAccentLeftIconPressed();
