...
class ButtonContainedGrayRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedGrayRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedGrayRightIconDefault createState() =>
      _ButtonContainedGrayRightIconDefault();
}

class _ButtonContainedGrayRightIconDefault
    extends State<ButtonContainedGrayRightIconDefault> {
  _ButtonContainedGrayRightIconDefault();
