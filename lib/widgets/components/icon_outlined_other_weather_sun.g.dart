...
class IconOutlinedOtherWeatherSun extends StatefulWidget {
  ...
  const IconOutlinedOtherWeatherSun(
    this.constraints, {
    Key? key,
    this.ovrVector,
    this.ovrVector2,
  ...
  @override
  _IconOutlinedOtherWeatherSun createState() => _IconOutlinedOtherWeatherSun();
}

class _IconOutlinedOtherWeatherSun extends State<IconOutlinedOtherWeatherSun> {
  _IconOutlinedOtherWeatherSun();
