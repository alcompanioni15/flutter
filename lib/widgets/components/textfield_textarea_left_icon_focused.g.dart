...
class TextfieldTextareaLeftIconFocused extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrPlaceholder;
  final Widget? ovriconoutlinedothermailmail;
  final String? ovrLabel;
  const TextfieldTextareaLeftIconFocused(
    this.constraints, {
    Key? key,
    this.ovrPlaceholder,
  ...
  @override
  _TextfieldTextareaLeftIconFocused createState() =>
      _TextfieldTextareaLeftIconFocused();
}

class _TextfieldTextareaLeftIconFocused
    extends State<TextfieldTextareaLeftIconFocused> {
  _TextfieldTextareaLeftIconFocused();
