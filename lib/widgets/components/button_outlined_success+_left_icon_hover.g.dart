...
class ButtonOutlinedSuccessLeftIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonOutlinedSuccessLeftIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedSuccessLeftIconHover createState() =>
      _ButtonOutlinedSuccessLeftIconHover();
}

class _ButtonOutlinedSuccessLeftIconHover
    extends State<ButtonOutlinedSuccessLeftIconHover> {
  _ButtonOutlinedSuccessLeftIconHover();
