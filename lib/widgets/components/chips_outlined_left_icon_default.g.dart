...
class ChipsOutlinedLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrChiplabel;
  final Widget? ovriconoutlinedotherlocationmappin;
  const ChipsOutlinedLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrChiplabel,
  ...
  @override
  _ChipsOutlinedLeftIconDefault createState() =>
      _ChipsOutlinedLeftIconDefault();
}

class _ChipsOutlinedLeftIconDefault
    extends State<ChipsOutlinedLeftIconDefault> {
  _ChipsOutlinedLeftIconDefault();
