...
class UploadUploadBoxIconTitleDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final String? ovrUpload;
  const UploadUploadBoxIconTitleDisabled(
    this.constraints, {
    Key? key,
  ...
  @override
  _UploadUploadBoxIconTitleDisabled createState() =>
      _UploadUploadBoxIconTitleDisabled();
}

class _UploadUploadBoxIconTitleDisabled
    extends State<UploadUploadBoxIconTitleDisabled> {
  _UploadUploadBoxIconTitleDisabled();
