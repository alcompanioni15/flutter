...
class ButtonContainedErrorRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedErrorRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedErrorRightIconDisabled createState() =>
      _ButtonContainedErrorRightIconDisabled();
}

class _ButtonContainedErrorRightIconDisabled
    extends State<ButtonContainedErrorRightIconDisabled> {
  _ButtonContainedErrorRightIconDisabled();
