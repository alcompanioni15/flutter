...
class ButtonContainedSuccessLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedSuccessLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedSuccessLeftIconDisabled createState() =>
      _ButtonContainedSuccessLeftIconDisabled();
}

class _ButtonContainedSuccessLeftIconDisabled
    extends State<ButtonContainedSuccessLeftIconDisabled> {
  _ButtonContainedSuccessLeftIconDisabled();
