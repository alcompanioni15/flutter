...
class PopconfirmPlacementRightBottom extends StatefulWidget {
  ...
  const PopconfirmPlacementRightBottom(
    this.constraints, {
    Key? key,
    this.ovrsheet,
  ...
  @override
  _PopconfirmPlacementRightBottom createState() =>
      _PopconfirmPlacementRightBottom();
}

class _PopconfirmPlacementRightBottom
    extends State<PopconfirmPlacementRightBottom> {
  _PopconfirmPlacementRightBottom();
                ...
                child: LayoutBuilder(builder: (context, constraints) {
                  return IconOutlinedSuggestedCircle(
                    ...
                    ovrVector: SvgPicture.asset(
                      ...
                      width: widget.constraints.maxWidth * 0.05128173828125,
                      fit: BoxFit.fill,
                    ),
                    ...
                    ovrVector3: SvgPicture.asset(
                      ...
                      width:
                          widget.constraints.maxWidth * 0.000025353064903846155,
                      fit: BoxFit.fill,
                    ),
                  );
                }),
