...
class ButtonContainedSuccessLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedSuccessLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedSuccessLeftIconDefault createState() =>
      _ButtonContainedSuccessLeftIconDefault();
}

class _ButtonContainedSuccessLeftIconDefault
    extends State<ButtonContainedSuccessLeftIconDefault> {
  _ButtonContainedSuccessLeftIconDefault();
