...
class ButtonTextErrorLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextErrorLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextErrorLeftIconDisabled createState() =>
      _ButtonTextErrorLeftIconDisabled();
}

class _ButtonTextErrorLeftIconDisabled
    extends State<ButtonTextErrorLeftIconDisabled> {
  _ButtonTextErrorLeftIconDisabled();
