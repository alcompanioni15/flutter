...
class ButtonContainedWarningRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedWarningRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedWarningRightIconDefault createState() =>
      _ButtonContainedWarningRightIconDefault();
}

class _ButtonContainedWarningRightIconDefault
    extends State<ButtonContainedWarningRightIconDefault> {
  _ButtonContainedWarningRightIconDefault();
