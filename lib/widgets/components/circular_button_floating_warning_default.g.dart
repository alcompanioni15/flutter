...
class CircularButtonFloatingWarningDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFloatingWarningDefault(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingWarningDefault createState() =>
      _CircularButtonFloatingWarningDefault();
}

class _CircularButtonFloatingWarningDefault
    extends State<CircularButtonFloatingWarningDefault> {
  _CircularButtonFloatingWarningDefault();
