...
class ButtonOutlinedAccentRightIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedAccentRightIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedAccentRightIconPressed createState() =>
      _ButtonOutlinedAccentRightIconPressed();
}

class _ButtonOutlinedAccentRightIconPressed
    extends State<ButtonOutlinedAccentRightIconPressed> {
  _ButtonOutlinedAccentRightIconPressed();
