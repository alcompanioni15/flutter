...
class ButtonTextErrorRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextErrorRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextErrorRightIconDisabled createState() =>
      _ButtonTextErrorRightIconDisabled();
}

class _ButtonTextErrorRightIconDisabled
    extends State<ButtonTextErrorRightIconDisabled> {
  _ButtonTextErrorRightIconDisabled();
