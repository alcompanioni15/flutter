...
class ButtonTextSuccessRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextSuccessRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextSuccessRightIconDefault createState() =>
      _ButtonTextSuccessRightIconDefault();
}

class _ButtonTextSuccessRightIconDefault
    extends State<ButtonTextSuccessRightIconDefault> {
  _ButtonTextSuccessRightIconDefault();
