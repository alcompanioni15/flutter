...
class ChipsFilledClearOptionDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrChiplabel;
  final Widget? ovriconoutlinedsuggestedcirclex;
  const ChipsFilledClearOptionDefault(
    this.constraints, {
    Key? key,
    this.ovrChiplabel,
  ...
  @override
  _ChipsFilledClearOptionDefault createState() =>
      _ChipsFilledClearOptionDefault();
}

class _ChipsFilledClearOptionDefault
    extends State<ChipsFilledClearOptionDefault> {
  _ChipsFilledClearOptionDefault();
