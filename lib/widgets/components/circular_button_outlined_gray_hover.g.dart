...
class CircularButtonOutlinedGrayHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  final Widget? ovrCursorPointinghand;
  const CircularButtonOutlinedGrayHover(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedGrayHover createState() =>
      _CircularButtonOutlinedGrayHover();
}

class _CircularButtonOutlinedGrayHover
    extends State<CircularButtonOutlinedGrayHover> {
  _CircularButtonOutlinedGrayHover();
