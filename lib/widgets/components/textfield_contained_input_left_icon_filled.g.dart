...
class TextfieldContainedInputLeftIconFilled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrPlaceholder;
  final Widget? ovriconoutlinedothermailmail;
  final String? ovrLabel;
  const TextfieldContainedInputLeftIconFilled(
    this.constraints, {
    Key? key,
    this.ovrPlaceholder,
  ...
  @override
  _TextfieldContainedInputLeftIconFilled createState() =>
      _TextfieldContainedInputLeftIconFilled();
}

class _TextfieldContainedInputLeftIconFilled
    extends State<TextfieldContainedInputLeftIconFilled> {
  _TextfieldContainedInputLeftIconFilled();
