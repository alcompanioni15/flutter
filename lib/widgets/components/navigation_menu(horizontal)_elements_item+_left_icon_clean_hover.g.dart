...
class NavigationMenuhorizontalElementsItemLeftIconCleanHover
    extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovriconoutlinedotherlocationhome;
  final String? ovrlabel;
  final Widget? ovrCursorPointinghand;
  const NavigationMenuhorizontalElementsItemLeftIconCleanHover(
    this.constraints, {
    Key? key,
  ...
  @override
  _NavigationMenuhorizontalElementsItemLeftIconCleanHover createState() =>
      _NavigationMenuhorizontalElementsItemLeftIconCleanHover();
}

class _NavigationMenuhorizontalElementsItemLeftIconCleanHover
    extends State<NavigationMenuhorizontalElementsItemLeftIconCleanHover> {
  _NavigationMenuhorizontalElementsItemLeftIconCleanHover();
