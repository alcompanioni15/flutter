...
class TextfieldContainedInputRightAndLeftIconsError extends StatefulWidget {
  ...
  const TextfieldContainedInputRightAndLeftIconsError(
    this.constraints, {
    Key? key,
  ...
  @override
  _TextfieldContainedInputRightAndLeftIconsError createState() =>
      _TextfieldContainedInputRightAndLeftIconsError();
}

class _TextfieldContainedInputRightAndLeftIconsError
    extends State<TextfieldContainedInputRightAndLeftIconsError> {
  _TextfieldContainedInputRightAndLeftIconsError();
