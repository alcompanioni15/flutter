...
class ButtonContainedErrorRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedErrorRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedErrorRightIconDefault createState() =>
      _ButtonContainedErrorRightIconDefault();
}

class _ButtonContainedErrorRightIconDefault
    extends State<ButtonContainedErrorRightIconDefault> {
  _ButtonContainedErrorRightIconDefault();
