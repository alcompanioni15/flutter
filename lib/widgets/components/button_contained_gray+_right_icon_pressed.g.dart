...
class ButtonContainedGrayRightIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedGrayRightIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedGrayRightIconPressed createState() =>
      _ButtonContainedGrayRightIconPressed();
}

class _ButtonContainedGrayRightIconPressed
    extends State<ButtonContainedGrayRightIconPressed> {
  _ButtonContainedGrayRightIconPressed();
