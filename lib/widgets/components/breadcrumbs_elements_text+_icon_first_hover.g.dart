...
class BreadcrumbsElementsTextIconFirstHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrlinklabel;
  final Widget? ovrCursorPointinghand;
  final Widget? ovriconoutlinedotherlocationhome;
  final String? ovrdivider;
  const BreadcrumbsElementsTextIconFirstHover(
    this.constraints, {
    Key? key,
    this.ovrlinklabel,
  ...
  @override
  _BreadcrumbsElementsTextIconFirstHover createState() =>
      _BreadcrumbsElementsTextIconFirstHover();
}

class _BreadcrumbsElementsTextIconFirstHover
    extends State<BreadcrumbsElementsTextIconFirstHover> {
  _BreadcrumbsElementsTextIconFirstHover();
