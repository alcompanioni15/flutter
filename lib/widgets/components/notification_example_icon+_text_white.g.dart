...
class NotificationExampleIconTextWhite extends StatefulWidget {
  ...
  const NotificationExampleIconTextWhite(
    this.constraints, {
    Key? key,
  ...
  @override
  _NotificationExampleIconTextWhite createState() =>
      _NotificationExampleIconTextWhite();
}

class _NotificationExampleIconTextWhite
    extends State<NotificationExampleIconTextWhite> {
  _NotificationExampleIconTextWhite();
