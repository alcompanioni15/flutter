...
class ButtonTextAccentLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextAccentLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextAccentLeftIconDisabled createState() =>
      _ButtonTextAccentLeftIconDisabled();
}

class _ButtonTextAccentLeftIconDisabled
    extends State<ButtonTextAccentLeftIconDisabled> {
  _ButtonTextAccentLeftIconDisabled();
                ...
                child: LayoutBuilder(builder: (context, constraints) {
                  return IconOutlinedSuggestedSymbol(
                    ...
                    ovrVector: SvgPicture.asset(
                      ...
                      package: 'kadeca',
                      height: widget.constraints.maxHeight * 0.2430553436279297,
