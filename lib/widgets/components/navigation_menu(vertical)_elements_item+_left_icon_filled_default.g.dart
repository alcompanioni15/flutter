...
class NavigationMenuverticalElementsItemLeftIconFilledDefault
    extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovriconoutlinedothermailarchive;
  final String? ovrlabel;
  const NavigationMenuverticalElementsItemLeftIconFilledDefault(
    this.constraints, {
    Key? key,
  ...
  @override
  _NavigationMenuverticalElementsItemLeftIconFilledDefault createState() =>
      _NavigationMenuverticalElementsItemLeftIconFilledDefault();
}

class _NavigationMenuverticalElementsItemLeftIconFilledDefault
    extends State<NavigationMenuverticalElementsItemLeftIconFilledDefault> {
  _NavigationMenuverticalElementsItemLeftIconFilledDefault();
