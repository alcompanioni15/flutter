...
class CircularButtonFloatingGrayHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  final Widget? ovrCursorPointinghand;
  const CircularButtonFloatingGrayHover(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingGrayHover createState() =>
      _CircularButtonFloatingGrayHover();
}

class _CircularButtonFloatingGrayHover
    extends State<CircularButtonFloatingGrayHover> {
  _CircularButtonFloatingGrayHover();
