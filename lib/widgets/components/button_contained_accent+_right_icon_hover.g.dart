...
class ButtonContainedAccentRightIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonContainedAccentRightIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedAccentRightIconHover createState() =>
      _ButtonContainedAccentRightIconHover();
}

class _ButtonContainedAccentRightIconHover
    extends State<ButtonContainedAccentRightIconHover> {
  _ButtonContainedAccentRightIconHover();
