...
class ChipsOutlinedClearPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrChiplabel;
  final Widget? ovriconoutlinedsuggestedcirclex;
  const ChipsOutlinedClearPressed(
    this.constraints, {
    Key? key,
    this.ovrChiplabel,
  ...
  @override
  _ChipsOutlinedClearPressed createState() => _ChipsOutlinedClearPressed();
}

class _ChipsOutlinedClearPressed extends State<ChipsOutlinedClearPressed> {
  _ChipsOutlinedClearPressed();
