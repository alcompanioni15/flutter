...
class CircularButtonOutlinedErrorDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonOutlinedErrorDisabled(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedErrorDisabled createState() =>
      _CircularButtonOutlinedErrorDisabled();
}

class _CircularButtonOutlinedErrorDisabled
    extends State<CircularButtonOutlinedErrorDisabled> {
  _CircularButtonOutlinedErrorDisabled();
