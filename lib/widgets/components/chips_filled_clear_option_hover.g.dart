...
class ChipsFilledClearOptionHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrChiplabel;
  final Widget? ovriconoutlinedsuggestedcirclex;
  final Widget? ovrCursorPointinghand;
  const ChipsFilledClearOptionHover(
    this.constraints, {
    Key? key,
    this.ovrChiplabel,
  ...
  @override
  _ChipsFilledClearOptionHover createState() => _ChipsFilledClearOptionHover();
}

class _ChipsFilledClearOptionHover extends State<ChipsFilledClearOptionHover> {
  _ChipsFilledClearOptionHover();
