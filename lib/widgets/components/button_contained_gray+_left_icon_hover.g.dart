...
class ButtonContainedGrayLeftIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonContainedGrayLeftIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedGrayLeftIconHover createState() =>
      _ButtonContainedGrayLeftIconHover();
}

class _ButtonContainedGrayLeftIconHover
    extends State<ButtonContainedGrayLeftIconHover> {
  _ButtonContainedGrayLeftIconHover();
