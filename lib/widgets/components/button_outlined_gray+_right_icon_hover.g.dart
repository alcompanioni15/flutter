...
class ButtonOutlinedGrayRightIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonOutlinedGrayRightIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedGrayRightIconHover createState() =>
      _ButtonOutlinedGrayRightIconHover();
}

class _ButtonOutlinedGrayRightIconHover
    extends State<ButtonOutlinedGrayRightIconHover> {
  _ButtonOutlinedGrayRightIconHover();
