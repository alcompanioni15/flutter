...
class CircularButtonFloatingAccentPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFloatingAccentPressed(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingAccentPressed createState() =>
      _CircularButtonFloatingAccentPressed();
}

class _CircularButtonFloatingAccentPressed
    extends State<CircularButtonFloatingAccentPressed> {
  _CircularButtonFloatingAccentPressed();
