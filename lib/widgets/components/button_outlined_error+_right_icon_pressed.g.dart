...
class ButtonOutlinedErrorRightIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedErrorRightIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedErrorRightIconPressed createState() =>
      _ButtonOutlinedErrorRightIconPressed();
}

class _ButtonOutlinedErrorRightIconPressed
    extends State<ButtonOutlinedErrorRightIconPressed> {
  _ButtonOutlinedErrorRightIconPressed();
