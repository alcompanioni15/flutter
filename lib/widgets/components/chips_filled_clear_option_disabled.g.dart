...
class ChipsFilledClearOptionDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrChiplabel;
  final Widget? ovriconoutlinedsuggestedcirclex;
  const ChipsFilledClearOptionDisabled(
    this.constraints, {
    Key? key,
    this.ovrChiplabel,
  ...
  @override
  _ChipsFilledClearOptionDisabled createState() =>
      _ChipsFilledClearOptionDisabled();
}

class _ChipsFilledClearOptionDisabled
    extends State<ChipsFilledClearOptionDisabled> {
  _ChipsFilledClearOptionDisabled();
