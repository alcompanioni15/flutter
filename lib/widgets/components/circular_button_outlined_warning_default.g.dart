...
class CircularButtonOutlinedWarningDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonOutlinedWarningDefault(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedWarningDefault createState() =>
      _CircularButtonOutlinedWarningDefault();
}

class _CircularButtonOutlinedWarningDefault
    extends State<CircularButtonOutlinedWarningDefault> {
  _CircularButtonOutlinedWarningDefault();
