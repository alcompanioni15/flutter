...
class ButtonOutlinedWarningRightIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonOutlinedWarningRightIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedWarningRightIconHover createState() =>
      _ButtonOutlinedWarningRightIconHover();
}

class _ButtonOutlinedWarningRightIconHover
    extends State<ButtonOutlinedWarningRightIconHover> {
  _ButtonOutlinedWarningRightIconHover();
