...
class CircularButtonOutlinedAccentHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  final Widget? ovrCursorPointinghand;
  const CircularButtonOutlinedAccentHover(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedAccentHover createState() =>
      _CircularButtonOutlinedAccentHover();
}

class _CircularButtonOutlinedAccentHover
    extends State<CircularButtonOutlinedAccentHover> {
  _CircularButtonOutlinedAccentHover();
