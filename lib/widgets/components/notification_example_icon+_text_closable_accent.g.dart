...
class NotificationExampleIconTextClosableAccent extends StatefulWidget {
  ...
  const NotificationExampleIconTextClosableAccent(
    this.constraints, {
    Key? key,
  ...
  @override
  _NotificationExampleIconTextClosableAccent createState() =>
      _NotificationExampleIconTextClosableAccent();
}

class _NotificationExampleIconTextClosableAccent
    extends State<NotificationExampleIconTextClosableAccent> {
  _NotificationExampleIconTextClosableAccent();
