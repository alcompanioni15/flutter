...
class ButtonOutlinedSuccessLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedSuccessLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedSuccessLeftIconDisabled createState() =>
      _ButtonOutlinedSuccessLeftIconDisabled();
}

class _ButtonOutlinedSuccessLeftIconDisabled
    extends State<ButtonOutlinedSuccessLeftIconDisabled> {
  _ButtonOutlinedSuccessLeftIconDisabled();
