...
class TableElementsPaginationCleanArrowsRightDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovriconoutlineddirectionschevronright;
  const TableElementsPaginationCleanArrowsRightDisabled(
    this.constraints, {
    Key? key,
    this.ovriconoutlineddirectionschevronright,
  }) : super(key: key);
  @override
  _TableElementsPaginationCleanArrowsRightDisabled createState() =>
      _TableElementsPaginationCleanArrowsRightDisabled();
}

class _TableElementsPaginationCleanArrowsRightDisabled
    extends State<TableElementsPaginationCleanArrowsRightDisabled> {
  _TableElementsPaginationCleanArrowsRightDisabled();
