...
class BadgeSingleIconWarning extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrbadge;
  final Widget? ovriconoutlinedactionmainclock;
  const BadgeSingleIconWarning(
    this.constraints, {
    Key? key,
    this.ovrbadge,
  ...
  @override
  _BadgeSingleIconWarning createState() => _BadgeSingleIconWarning();
}

class _BadgeSingleIconWarning extends State<BadgeSingleIconWarning> {
  _BadgeSingleIconWarning();
