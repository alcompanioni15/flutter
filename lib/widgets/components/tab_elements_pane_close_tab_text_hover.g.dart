...
class TabElementsPaneCloseTabTextHover extends StatefulWidget {
  ...
  @override
  _TabElementsPaneCloseTabTextHover createState() =>
      _TabElementsPaneCloseTabTextHover();
}

class _TabElementsPaneCloseTabTextHover
    extends State<TabElementsPaneCloseTabTextHover> {
  _TabElementsPaneCloseTabTextHover();
