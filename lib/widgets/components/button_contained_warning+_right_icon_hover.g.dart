...
class ButtonContainedWarningRightIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonContainedWarningRightIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedWarningRightIconHover createState() =>
      _ButtonContainedWarningRightIconHover();
}

class _ButtonContainedWarningRightIconHover
    extends State<ButtonContainedWarningRightIconHover> {
  _ButtonContainedWarningRightIconHover();
