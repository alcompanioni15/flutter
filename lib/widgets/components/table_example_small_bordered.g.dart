...
import 'package:kadeca/widgets/components/table_elements_columns_small_textual+_divider_icon_left.g.dart';
import 'package:kadeca/widgets/components/table_elements_columns_small_numeric_default.g.dart';
import 'package:kadeca/widgets/components/table_elements_columns_small_actions+_divider_checboxes_unchecked.g.dart';
import 'package:kadeca/widgets/components/table_elements_columns_small_textual+_divider_default.g.dart';
...
class TableExampleSmallBordered extends StatefulWidget {
  ...
  final Widget? ovrtableelementscolumnssmalltextualdividericonleft;
  final Widget? ovrtableelementscolumnssmallnumericdefault;
  final Widget? ovrtableelementscolumnssmallactionsdividerchecboxesunchecked;
  final Widget? ovrtableelementscolumnssmalltextualdividerdefault;
  const TableExampleSmallBordered(
    this.constraints, {
    Key? key,
    ...
    this.ovrtableelementscolumnssmalltextualdividericonleft,
    this.ovrtableelementscolumnssmallnumericdefault,
    this.ovrtableelementscolumnssmallactionsdividerchecboxesunchecked,
    this.ovrtableelementscolumnssmalltextualdividerdefault,
  }) : super(key: key);
  @override
  _TableExampleSmallBordered createState() => _TableExampleSmallBordered();
}

class _TableExampleSmallBordered extends State<TableExampleSmallBordered> {
  _TableExampleSmallBordered();
          ...
          Positioned(
            ...
            child: Stack(children: [
              ...
              Positioned(
                ...
                bottom: 80.0,
                child: LayoutBuilder(builder: (context, constraints) {
                  return TableElementsColumnsSmallTextualDividerIconLeft(
                    constraints,
              ...
              Positioned(
                ...
                bottom: 80.0,
                child: LayoutBuilder(builder: (context, constraints) {
                  return TableElementsColumnsSmallActionsDividerChecboxesUnchecked(
                    constraints,
                  );
                }),
              ),
              Positioned(
                ...
                bottom: 80.0,
                child: LayoutBuilder(builder: (context, constraints) {
                  return TableElementsColumnsSmallTextualDividerDefault(
                    constraints,
