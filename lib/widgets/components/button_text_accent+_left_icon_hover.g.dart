...
class ButtonTextAccentLeftIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrCursorPointinghand;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextAccentLeftIconHover(
    this.constraints, {
    Key? key,
  ...
  @override
  _ButtonTextAccentLeftIconHover createState() =>
      _ButtonTextAccentLeftIconHover();
}

class _ButtonTextAccentLeftIconHover
    extends State<ButtonTextAccentLeftIconHover> {
  _ButtonTextAccentLeftIconHover();
