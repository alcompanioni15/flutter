...
class CircularButtonOutlinedAccentPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonOutlinedAccentPressed(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedAccentPressed createState() =>
      _CircularButtonOutlinedAccentPressed();
}

class _CircularButtonOutlinedAccentPressed
    extends State<CircularButtonOutlinedAccentPressed> {
  _CircularButtonOutlinedAccentPressed();
