...
class ButtonOutlinedWarningRightIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedWarningRightIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedWarningRightIconPressed createState() =>
      _ButtonOutlinedWarningRightIconPressed();
}

class _ButtonOutlinedWarningRightIconPressed
    extends State<ButtonOutlinedWarningRightIconPressed> {
  _ButtonOutlinedWarningRightIconPressed();
