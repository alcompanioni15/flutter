...
class TabElementsPaneCloseTabTextIconSelected extends StatefulWidget {
  ...
  const TabElementsPaneCloseTabTextIconSelected(
    this.constraints, {
    Key? key,
  ...
  @override
  _TabElementsPaneCloseTabTextIconSelected createState() =>
      _TabElementsPaneCloseTabTextIconSelected();
}

class _TabElementsPaneCloseTabTextIconSelected
    extends State<TabElementsPaneCloseTabTextIconSelected> {
  _TabElementsPaneCloseTabTextIconSelected();
