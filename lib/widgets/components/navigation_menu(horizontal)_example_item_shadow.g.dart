...
class NavigationMenuhorizontalExampleItemShadow extends StatefulWidget {
  ...
  const NavigationMenuhorizontalExampleItemShadow(
    this.constraints, {
    Key? key,
  ...
  @override
  _NavigationMenuhorizontalExampleItemShadow createState() =>
      _NavigationMenuhorizontalExampleItemShadow();
}

class _NavigationMenuhorizontalExampleItemShadow
    extends State<NavigationMenuhorizontalExampleItemShadow> {
  _NavigationMenuhorizontalExampleItemShadow();
