...
class CircularButtonFloatingGrayDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFloatingGrayDisabled(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingGrayDisabled createState() =>
      _CircularButtonFloatingGrayDisabled();
}

class _CircularButtonFloatingGrayDisabled
    extends State<CircularButtonFloatingGrayDisabled> {
  _CircularButtonFloatingGrayDisabled();
