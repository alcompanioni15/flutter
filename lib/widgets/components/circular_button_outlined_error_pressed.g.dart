...
class CircularButtonOutlinedErrorPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonOutlinedErrorPressed(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedErrorPressed createState() =>
      _CircularButtonOutlinedErrorPressed();
}

class _CircularButtonOutlinedErrorPressed
    extends State<CircularButtonOutlinedErrorPressed> {
  _CircularButtonOutlinedErrorPressed();
