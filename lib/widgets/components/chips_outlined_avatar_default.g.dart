...
class ChipsOutlinedAvatarDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovravatarcircledwoman01;
  final String? ovrChiplabel;
  const ChipsOutlinedAvatarDefault(
    this.constraints, {
    Key? key,
  ...
  @override
  _ChipsOutlinedAvatarDefault createState() => _ChipsOutlinedAvatarDefault();
}

class _ChipsOutlinedAvatarDefault extends State<ChipsOutlinedAvatarDefault> {
  _ChipsOutlinedAvatarDefault();
