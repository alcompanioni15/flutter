...
class ButtonTextErrorRightIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrCursorPointinghand;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextErrorRightIconHover(
    this.constraints, {
    Key? key,
  ...
  @override
  _ButtonTextErrorRightIconHover createState() =>
      _ButtonTextErrorRightIconHover();
}

class _ButtonTextErrorRightIconHover
    extends State<ButtonTextErrorRightIconHover> {
  _ButtonTextErrorRightIconHover();
