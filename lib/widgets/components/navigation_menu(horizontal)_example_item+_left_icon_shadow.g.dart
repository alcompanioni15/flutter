...
class NavigationMenuhorizontalExampleItemLeftIconShadow extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrnavigationmenuhorizontalelementssheetshadow;
  ...
  const NavigationMenuhorizontalExampleItemLeftIconShadow(
    this.constraints, {
    Key? key,
    this.ovrnavigationmenuhorizontalelementssheetshadow,
  ...
  @override
  _NavigationMenuhorizontalExampleItemLeftIconShadow createState() =>
      _NavigationMenuhorizontalExampleItemLeftIconShadow();
}

class _NavigationMenuhorizontalExampleItemLeftIconShadow
    extends State<NavigationMenuhorizontalExampleItemLeftIconShadow> {
  _NavigationMenuhorizontalExampleItemLeftIconShadow();
