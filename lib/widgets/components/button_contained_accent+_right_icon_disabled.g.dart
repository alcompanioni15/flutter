...
class ButtonContainedAccentRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedAccentRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedAccentRightIconDisabled createState() =>
      _ButtonContainedAccentRightIconDisabled();
}

class _ButtonContainedAccentRightIconDisabled
    extends State<ButtonContainedAccentRightIconDisabled> {
  _ButtonContainedAccentRightIconDisabled();
