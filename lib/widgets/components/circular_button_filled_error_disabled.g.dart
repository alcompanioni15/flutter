...
class CircularButtonFilledErrorDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFilledErrorDisabled(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFilledErrorDisabled createState() =>
      _CircularButtonFilledErrorDisabled();
}

class _CircularButtonFilledErrorDisabled
    extends State<CircularButtonFilledErrorDisabled> {
  _CircularButtonFilledErrorDisabled();
