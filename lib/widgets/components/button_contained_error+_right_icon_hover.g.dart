...
class ButtonContainedErrorRightIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonContainedErrorRightIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedErrorRightIconHover createState() =>
      _ButtonContainedErrorRightIconHover();
}

class _ButtonContainedErrorRightIconHover
    extends State<ButtonContainedErrorRightIconHover> {
  _ButtonContainedErrorRightIconHover();
