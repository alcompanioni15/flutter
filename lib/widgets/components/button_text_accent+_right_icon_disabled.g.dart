...
class ButtonTextAccentRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextAccentRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextAccentRightIconDisabled createState() =>
      _ButtonTextAccentRightIconDisabled();
}

class _ButtonTextAccentRightIconDisabled
    extends State<ButtonTextAccentRightIconDisabled> {
  _ButtonTextAccentRightIconDisabled();
                ...
                child: LayoutBuilder(builder: (context, constraints) {
                  return IconOutlinedSuggestedSymbol(
                    ...
                    ovrVector: SvgPicture.asset(
                      ...
                      package: 'kadeca',
                      height:
                          widget.constraints.maxHeight * 0.24305597941080728,
