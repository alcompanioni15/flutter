...
class ButtonTextWarningLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextWarningLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextWarningLeftIconDisabled createState() =>
      _ButtonTextWarningLeftIconDisabled();
}

class _ButtonTextWarningLeftIconDisabled
    extends State<ButtonTextWarningLeftIconDisabled> {
  _ButtonTextWarningLeftIconDisabled();
