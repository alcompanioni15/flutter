...
class TabElementsTabTextIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrlabel;
  final Widget? ovriconoutlinededitorothereditform;
  const TabElementsTabTextIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrlabel,
  ...
  @override
  _TabElementsTabTextIconDisabled createState() =>
      _TabElementsTabTextIconDisabled();
}

class _TabElementsTabTextIconDisabled
    extends State<TabElementsTabTextIconDisabled> {
  _TabElementsTabTextIconDisabled();
