...
class CircularButtonOutlinedSuccessHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  final Widget? ovrCursorPointinghand;
  const CircularButtonOutlinedSuccessHover(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedSuccessHover createState() =>
      _CircularButtonOutlinedSuccessHover();
}

class _CircularButtonOutlinedSuccessHover
    extends State<CircularButtonOutlinedSuccessHover> {
  _CircularButtonOutlinedSuccessHover();
