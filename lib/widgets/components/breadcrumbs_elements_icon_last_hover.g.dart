...
class BreadcrumbsElementsIconLastHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovriconoutlinedotherlocationhome;
  final Widget? ovrCursorPointinghand;
  final String? ovrdivider;
  const BreadcrumbsElementsIconLastHover(
    this.constraints, {
    Key? key,
  ...
  @override
  _BreadcrumbsElementsIconLastHover createState() =>
      _BreadcrumbsElementsIconLastHover();
}

class _BreadcrumbsElementsIconLastHover
    extends State<BreadcrumbsElementsIconLastHover> {
  _BreadcrumbsElementsIconLastHover();
