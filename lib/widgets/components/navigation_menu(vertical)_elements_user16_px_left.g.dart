...
class NavigationMenuverticalElementsUser16PxLeft extends StatefulWidget {
  ...
  const NavigationMenuverticalElementsUser16PxLeft(
    this.constraints, {
    Key? key,
  ...
  @override
  _NavigationMenuverticalElementsUser16PxLeft createState() =>
      _NavigationMenuverticalElementsUser16PxLeft();
}

class _NavigationMenuverticalElementsUser16PxLeft
    extends State<NavigationMenuverticalElementsUser16PxLeft> {
  _NavigationMenuverticalElementsUser16PxLeft();
