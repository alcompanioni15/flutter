...
class ButtonOutlinedAccentRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedAccentRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedAccentRightIconDisabled createState() =>
      _ButtonOutlinedAccentRightIconDisabled();
}

class _ButtonOutlinedAccentRightIconDisabled
    extends State<ButtonOutlinedAccentRightIconDisabled> {
  _ButtonOutlinedAccentRightIconDisabled();
