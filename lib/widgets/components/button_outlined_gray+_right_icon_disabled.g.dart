...
class ButtonOutlinedGrayRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedGrayRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedGrayRightIconDisabled createState() =>
      _ButtonOutlinedGrayRightIconDisabled();
}

class _ButtonOutlinedGrayRightIconDisabled
    extends State<ButtonOutlinedGrayRightIconDisabled> {
  _ButtonOutlinedGrayRightIconDisabled();
