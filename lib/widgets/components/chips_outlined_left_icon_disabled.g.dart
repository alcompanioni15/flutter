...
class ChipsOutlinedLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrChiplabel;
  final Widget? ovriconoutlinedotherlocationmappin;
  const ChipsOutlinedLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrChiplabel,
  ...
  @override
  _ChipsOutlinedLeftIconDisabled createState() =>
      _ChipsOutlinedLeftIconDisabled();
}

class _ChipsOutlinedLeftIconDisabled
    extends State<ChipsOutlinedLeftIconDisabled> {
  _ChipsOutlinedLeftIconDisabled();
