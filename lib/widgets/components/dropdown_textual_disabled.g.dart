...
class DropdownTextualDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrDropdown;
  final Widget? ovriconoutlineddirectionschevrondown;
  const DropdownTextualDisabled(
    this.constraints, {
    Key? key,
    this.ovrDropdown,
  ...
  @override
  _DropdownTextualDisabled createState() => _DropdownTextualDisabled();
}

class _DropdownTextualDisabled extends State<DropdownTextualDisabled> {
  _DropdownTextualDisabled();
