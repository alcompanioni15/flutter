...
class ChipsOutlinedAvatarCloseHover extends StatefulWidget {
  ...
  @override
  _ChipsOutlinedAvatarCloseHover createState() =>
      _ChipsOutlinedAvatarCloseHover();
}

class _ChipsOutlinedAvatarCloseHover
    extends State<ChipsOutlinedAvatarCloseHover> {
  _ChipsOutlinedAvatarCloseHover();
