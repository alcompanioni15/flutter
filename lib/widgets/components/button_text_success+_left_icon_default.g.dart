...
class ButtonTextSuccessLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextSuccessLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextSuccessLeftIconDefault createState() =>
      _ButtonTextSuccessLeftIconDefault();
}

class _ButtonTextSuccessLeftIconDefault
    extends State<ButtonTextSuccessLeftIconDefault> {
  _ButtonTextSuccessLeftIconDefault();
