...
class ButtonOutlinedWarningLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedWarningLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedWarningLeftIconDefault createState() =>
      _ButtonOutlinedWarningLeftIconDefault();
}

class _ButtonOutlinedWarningLeftIconDefault
    extends State<ButtonOutlinedWarningLeftIconDefault> {
  _ButtonOutlinedWarningLeftIconDefault();
