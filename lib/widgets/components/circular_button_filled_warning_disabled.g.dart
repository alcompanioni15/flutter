...
class CircularButtonFilledWarningDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFilledWarningDisabled(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFilledWarningDisabled createState() =>
      _CircularButtonFilledWarningDisabled();
}

class _CircularButtonFilledWarningDisabled
    extends State<CircularButtonFilledWarningDisabled> {
  _CircularButtonFilledWarningDisabled();
