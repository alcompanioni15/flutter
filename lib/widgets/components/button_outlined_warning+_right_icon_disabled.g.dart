...
class ButtonOutlinedWarningRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedWarningRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedWarningRightIconDisabled createState() =>
      _ButtonOutlinedWarningRightIconDisabled();
}

class _ButtonOutlinedWarningRightIconDisabled
    extends State<ButtonOutlinedWarningRightIconDisabled> {
  _ButtonOutlinedWarningRightIconDisabled();
