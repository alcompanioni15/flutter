...
class TextfieldContainedInputRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrPlaceholder;
  final Widget? ovriconoutlinedactioneyeeyeon;
  final String? ovrLabel;
  const TextfieldContainedInputRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrPlaceholder,
  ...
  @override
  _TextfieldContainedInputRightIconDefault createState() =>
      _TextfieldContainedInputRightIconDefault();
}

class _TextfieldContainedInputRightIconDefault
    extends State<TextfieldContainedInputRightIconDefault> {
  _TextfieldContainedInputRightIconDefault();
