...
class ButtonContainedGrayRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedGrayRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedGrayRightIconDisabled createState() =>
      _ButtonContainedGrayRightIconDisabled();
}

class _ButtonContainedGrayRightIconDisabled
    extends State<ButtonContainedGrayRightIconDisabled> {
  _ButtonContainedGrayRightIconDisabled();
