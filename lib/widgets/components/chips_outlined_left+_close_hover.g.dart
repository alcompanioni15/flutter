...
class ChipsOutlinedLeftCloseHover extends StatefulWidget {
  ...
  const ChipsOutlinedLeftCloseHover(
    this.constraints, {
    Key? key,
    this.ovrChiplabel,
  ...
  @override
  _ChipsOutlinedLeftCloseHover createState() => _ChipsOutlinedLeftCloseHover();
}

class _ChipsOutlinedLeftCloseHover extends State<ChipsOutlinedLeftCloseHover> {
  _ChipsOutlinedLeftCloseHover();
