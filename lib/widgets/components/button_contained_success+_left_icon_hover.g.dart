...
class ButtonContainedSuccessLeftIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonContainedSuccessLeftIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedSuccessLeftIconHover createState() =>
      _ButtonContainedSuccessLeftIconHover();
}

class _ButtonContainedSuccessLeftIconHover
    extends State<ButtonContainedSuccessLeftIconHover> {
  _ButtonContainedSuccessLeftIconHover();
