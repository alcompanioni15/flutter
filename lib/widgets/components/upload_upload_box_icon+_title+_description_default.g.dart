...
class UploadUploadBoxIconTitleDescriptionDefault extends StatefulWidget {
  ...
  const UploadUploadBoxIconTitleDescriptionDefault(
    this.constraints, {
    Key? key,
  ...
  @override
  _UploadUploadBoxIconTitleDescriptionDefault createState() =>
      _UploadUploadBoxIconTitleDescriptionDefault();
}

class _UploadUploadBoxIconTitleDescriptionDefault
    extends State<UploadUploadBoxIconTitleDescriptionDefault> {
  _UploadUploadBoxIconTitleDescriptionDefault();
                ...
                child: LayoutBuilder(builder: (context, constraints) {
                  return IconOutlinedSuggestedSymbol(
                    ...
                    ovrVector2: SvgPicture.asset(
                      ...
                      width: widget.constraints.maxWidth * 0.06782948693563771,
                      fit: BoxFit.fill,
                    ),
                  );
                }),
