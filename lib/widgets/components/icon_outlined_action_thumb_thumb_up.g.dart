...
class IconOutlinedActionThumbThumbUp extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrVector;
  const IconOutlinedActionThumbThumbUp(
    this.constraints, {
    Key? key,
    this.ovrVector,
  }) : super(key: key);
  @override
  _IconOutlinedActionThumbThumbUp createState() =>
      _IconOutlinedActionThumbThumbUp();
}

class _IconOutlinedActionThumbThumbUp
    extends State<IconOutlinedActionThumbThumbUp> {
  _IconOutlinedActionThumbThumbUp();
