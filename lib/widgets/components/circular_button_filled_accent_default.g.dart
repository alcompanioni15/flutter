...
class CircularButtonFilledAccentDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFilledAccentDefault(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFilledAccentDefault createState() =>
      _CircularButtonFilledAccentDefault();
}

class _CircularButtonFilledAccentDefault
    extends State<CircularButtonFilledAccentDefault> {
  _CircularButtonFilledAccentDefault();
