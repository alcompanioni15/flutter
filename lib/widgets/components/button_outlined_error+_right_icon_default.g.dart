...
class ButtonOutlinedErrorRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedErrorRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedErrorRightIconDefault createState() =>
      _ButtonOutlinedErrorRightIconDefault();
}

class _ButtonOutlinedErrorRightIconDefault
    extends State<ButtonOutlinedErrorRightIconDefault> {
  _ButtonOutlinedErrorRightIconDefault();
