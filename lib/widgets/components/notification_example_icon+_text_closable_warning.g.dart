...
class NotificationExampleIconTextClosableWarning extends StatefulWidget {
  ...
  const NotificationExampleIconTextClosableWarning(
    this.constraints, {
    Key? key,
  ...
  @override
  _NotificationExampleIconTextClosableWarning createState() =>
      _NotificationExampleIconTextClosableWarning();
}

class _NotificationExampleIconTextClosableWarning
    extends State<NotificationExampleIconTextClosableWarning> {
  _NotificationExampleIconTextClosableWarning();
