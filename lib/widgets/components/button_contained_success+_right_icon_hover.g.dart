...
class ButtonContainedSuccessRightIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonContainedSuccessRightIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedSuccessRightIconHover createState() =>
      _ButtonContainedSuccessRightIconHover();
}

class _ButtonContainedSuccessRightIconHover
    extends State<ButtonContainedSuccessRightIconHover> {
  _ButtonContainedSuccessRightIconHover();
            ...
            child: Stack(children: [
              Positioned(
                ...
                child: Container(
                  ...
                  width: 126.0,
                  decoration: BoxDecoration(
                    color: Color(0xff40dd7f),
                    borderRadius: BorderRadius.all(Radius.circular(8)),
                    boxShadow: [
                      BoxShadow(
                        color: Color(0x3d40dd7f),
                        spreadRadius: 20,
                        blurRadius: 20,
                        offset: Offset(0, 12),
                      ),
