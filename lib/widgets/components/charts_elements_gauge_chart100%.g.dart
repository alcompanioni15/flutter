...
class ChartsElementsGaugeChart100 extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrdonutchartstroke;
  const ChartsElementsGaugeChart100(
    this.constraints, {
    Key? key,
    this.ovrdonutchartstroke,
  }) : super(key: key);
  @override
  _ChartsElementsGaugeChart100 createState() => _ChartsElementsGaugeChart100();
}

class _ChartsElementsGaugeChart100 extends State<ChartsElementsGaugeChart100> {
  _ChartsElementsGaugeChart100();
