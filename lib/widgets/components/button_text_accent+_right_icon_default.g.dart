...
class ButtonTextAccentRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextAccentRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextAccentRightIconDefault createState() =>
      _ButtonTextAccentRightIconDefault();
}

class _ButtonTextAccentRightIconDefault
    extends State<ButtonTextAccentRightIconDefault> {
  _ButtonTextAccentRightIconDefault();
