...
class CardElementsTitlesAvatarLeft extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovravatarcircledwoman01;
  final Widget? ovrcardelementstitlestitlebody;
  const CardElementsTitlesAvatarLeft(
    this.constraints, {
    Key? key,
  ...
  @override
  _CardElementsTitlesAvatarLeft createState() =>
      _CardElementsTitlesAvatarLeft();
}

class _CardElementsTitlesAvatarLeft
    extends State<CardElementsTitlesAvatarLeft> {
  _CardElementsTitlesAvatarLeft();
