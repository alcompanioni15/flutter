...
class ChipsOutlinedAvatarClosePressed extends StatefulWidget {
  ...
  @override
  _ChipsOutlinedAvatarClosePressed createState() =>
      _ChipsOutlinedAvatarClosePressed();
}

class _ChipsOutlinedAvatarClosePressed
    extends State<ChipsOutlinedAvatarClosePressed> {
  _ChipsOutlinedAvatarClosePressed();
