...
class ButtonOutlinedErrorRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedErrorRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedErrorRightIconDisabled createState() =>
      _ButtonOutlinedErrorRightIconDisabled();
}

class _ButtonOutlinedErrorRightIconDisabled
    extends State<ButtonOutlinedErrorRightIconDisabled> {
  _ButtonOutlinedErrorRightIconDisabled();
