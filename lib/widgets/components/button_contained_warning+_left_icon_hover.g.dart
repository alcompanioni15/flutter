...
class ButtonContainedWarningLeftIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonContainedWarningLeftIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedWarningLeftIconHover createState() =>
      _ButtonContainedWarningLeftIconHover();
}

class _ButtonContainedWarningLeftIconHover
    extends State<ButtonContainedWarningLeftIconHover> {
  _ButtonContainedWarningLeftIconHover();
