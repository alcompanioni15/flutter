...
class ButtonContainedWarningLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedWarningLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedWarningLeftIconPressed createState() =>
      _ButtonContainedWarningLeftIconPressed();
}

class _ButtonContainedWarningLeftIconPressed
    extends State<ButtonContainedWarningLeftIconPressed> {
  _ButtonContainedWarningLeftIconPressed();
