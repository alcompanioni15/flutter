...
class ButtonContainedGrayRightIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonContainedGrayRightIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedGrayRightIconHover createState() =>
      _ButtonContainedGrayRightIconHover();
}

class _ButtonContainedGrayRightIconHover
    extends State<ButtonContainedGrayRightIconHover> {
  _ButtonContainedGrayRightIconHover();
