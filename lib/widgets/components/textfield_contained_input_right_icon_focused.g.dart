...
class TextfieldContainedInputRightIconFocused extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrPlaceholder;
  final Widget? ovriconoutlinedactioneyeeyeon;
  final String? ovrLabel;
  const TextfieldContainedInputRightIconFocused(
    this.constraints, {
    Key? key,
    this.ovrPlaceholder,
  ...
  @override
  _TextfieldContainedInputRightIconFocused createState() =>
      _TextfieldContainedInputRightIconFocused();
}

class _TextfieldContainedInputRightIconFocused
    extends State<TextfieldContainedInputRightIconFocused> {
  _TextfieldContainedInputRightIconFocused();
