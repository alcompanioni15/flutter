...
class ButtonContainedSuccessRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedSuccessRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedSuccessRightIconDefault createState() =>
      _ButtonContainedSuccessRightIconDefault();
}

class _ButtonContainedSuccessRightIconDefault
    extends State<ButtonContainedSuccessRightIconDefault> {
  _ButtonContainedSuccessRightIconDefault();
