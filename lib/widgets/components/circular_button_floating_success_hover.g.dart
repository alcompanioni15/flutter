...
class CircularButtonFloatingSuccessHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  final Widget? ovrCursorPointinghand;
  const CircularButtonFloatingSuccessHover(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingSuccessHover createState() =>
      _CircularButtonFloatingSuccessHover();
}

class _CircularButtonFloatingSuccessHover
    extends State<CircularButtonFloatingSuccessHover> {
  _CircularButtonFloatingSuccessHover();
