...
class ButtonTextAccentRightIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrCursorPointinghand;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextAccentRightIconHover(
    this.constraints, {
    Key? key,
  ...
  @override
  _ButtonTextAccentRightIconHover createState() =>
      _ButtonTextAccentRightIconHover();
}

class _ButtonTextAccentRightIconHover
    extends State<ButtonTextAccentRightIconHover> {
  _ButtonTextAccentRightIconHover();
