...
class ButtonContainedSuccessLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedSuccessLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedSuccessLeftIconPressed createState() =>
      _ButtonContainedSuccessLeftIconPressed();
}

class _ButtonContainedSuccessLeftIconPressed
    extends State<ButtonContainedSuccessLeftIconPressed> {
  _ButtonContainedSuccessLeftIconPressed();
