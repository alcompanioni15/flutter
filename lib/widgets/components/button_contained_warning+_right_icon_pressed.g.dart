...
class ButtonContainedWarningRightIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedWarningRightIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedWarningRightIconPressed createState() =>
      _ButtonContainedWarningRightIconPressed();
}

class _ButtonContainedWarningRightIconPressed
    extends State<ButtonContainedWarningRightIconPressed> {
  _ButtonContainedWarningRightIconPressed();
