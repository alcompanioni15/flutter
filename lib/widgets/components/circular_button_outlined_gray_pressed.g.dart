...
class CircularButtonOutlinedGrayPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonOutlinedGrayPressed(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedGrayPressed createState() =>
      _CircularButtonOutlinedGrayPressed();
}

class _CircularButtonOutlinedGrayPressed
    extends State<CircularButtonOutlinedGrayPressed> {
  _CircularButtonOutlinedGrayPressed();
