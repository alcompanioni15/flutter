...
class ButtonTextGrayRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextGrayRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextGrayRightIconDisabled createState() =>
      _ButtonTextGrayRightIconDisabled();
}

class _ButtonTextGrayRightIconDisabled
    extends State<ButtonTextGrayRightIconDisabled> {
  _ButtonTextGrayRightIconDisabled();
