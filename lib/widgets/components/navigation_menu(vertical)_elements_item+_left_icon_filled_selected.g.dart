...
class NavigationMenuverticalElementsItemLeftIconFilledSelected
    extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovriconoutlinedothermailarchive;
  final String? ovrlabel;
  const NavigationMenuverticalElementsItemLeftIconFilledSelected(
    this.constraints, {
    Key? key,
  ...
  @override
  _NavigationMenuverticalElementsItemLeftIconFilledSelected createState() =>
      _NavigationMenuverticalElementsItemLeftIconFilledSelected();
}

class _NavigationMenuverticalElementsItemLeftIconFilledSelected
    extends State<NavigationMenuverticalElementsItemLeftIconFilledSelected> {
  _NavigationMenuverticalElementsItemLeftIconFilledSelected();
