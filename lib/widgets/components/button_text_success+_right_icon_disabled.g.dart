...
class ButtonTextSuccessRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextSuccessRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextSuccessRightIconDisabled createState() =>
      _ButtonTextSuccessRightIconDisabled();
}

class _ButtonTextSuccessRightIconDisabled
    extends State<ButtonTextSuccessRightIconDisabled> {
  _ButtonTextSuccessRightIconDisabled();
