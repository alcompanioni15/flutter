...
class ButtonOutlinedGrayLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedGrayLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedGrayLeftIconDefault createState() =>
      _ButtonOutlinedGrayLeftIconDefault();
}

class _ButtonOutlinedGrayLeftIconDefault
    extends State<ButtonOutlinedGrayLeftIconDefault> {
  _ButtonOutlinedGrayLeftIconDefault();
