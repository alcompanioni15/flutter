...
class CircularButtonFilledWarningHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  final Widget? ovrCursorPointinghand;
  const CircularButtonFilledWarningHover(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFilledWarningHover createState() =>
      _CircularButtonFilledWarningHover();
}

class _CircularButtonFilledWarningHover
    extends State<CircularButtonFilledWarningHover> {
  _CircularButtonFilledWarningHover();
