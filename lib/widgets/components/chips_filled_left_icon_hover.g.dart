...
class ChipsFilledLeftIconHover extends StatefulWidget {
  ...
  @override
  _ChipsFilledLeftIconHover createState() => _ChipsFilledLeftIconHover();
}

class _ChipsFilledLeftIconHover extends State<ChipsFilledLeftIconHover> {
  _ChipsFilledLeftIconHover();
