...
class ButtonContainedWarningRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedWarningRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedWarningRightIconDisabled createState() =>
      _ButtonContainedWarningRightIconDisabled();
}

class _ButtonContainedWarningRightIconDisabled
    extends State<ButtonContainedWarningRightIconDisabled> {
  _ButtonContainedWarningRightIconDisabled();
