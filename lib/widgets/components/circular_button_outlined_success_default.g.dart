...
class CircularButtonOutlinedSuccessDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonOutlinedSuccessDefault(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonOutlinedSuccessDefault createState() =>
      _CircularButtonOutlinedSuccessDefault();
}

class _CircularButtonOutlinedSuccessDefault
    extends State<CircularButtonOutlinedSuccessDefault> {
  _CircularButtonOutlinedSuccessDefault();
