...
class ButtonContainedAccentLeftIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonContainedAccentLeftIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedAccentLeftIconHover createState() =>
      _ButtonContainedAccentLeftIconHover();
}

class _ButtonContainedAccentLeftIconHover
    extends State<ButtonContainedAccentLeftIconHover> {
  _ButtonContainedAccentLeftIconHover();
