...
class TabElementsPaneCloseTabTextIconDefault extends StatefulWidget {
  ...
  const TabElementsPaneCloseTabTextIconDefault(
    this.constraints, {
    Key? key,
  ...
  @override
  _TabElementsPaneCloseTabTextIconDefault createState() =>
      _TabElementsPaneCloseTabTextIconDefault();
}

class _TabElementsPaneCloseTabTextIconDefault
    extends State<TabElementsPaneCloseTabTextIconDefault> {
  _TabElementsPaneCloseTabTextIconDefault();
                ...
                child: LayoutBuilder(builder: (context, constraints) {
                  return IconOutlinedEditorOtherEditForm(
                    ...
                    ovrVector2: SvgPicture.asset(
                      ...
                      width: widget.constraints.maxWidth * 0.04754638671875,
                      fit: BoxFit.fill,
                    ),
                  );
                }),
