...
class ButtonOutlinedErrorLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedErrorLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedErrorLeftIconDisabled createState() =>
      _ButtonOutlinedErrorLeftIconDisabled();
}

class _ButtonOutlinedErrorLeftIconDisabled
    extends State<ButtonOutlinedErrorLeftIconDisabled> {
  _ButtonOutlinedErrorLeftIconDisabled();
