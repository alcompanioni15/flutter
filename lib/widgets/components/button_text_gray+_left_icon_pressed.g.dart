...
class ButtonTextGrayLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextGrayLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextGrayLeftIconPressed createState() =>
      _ButtonTextGrayLeftIconPressed();
}

class _ButtonTextGrayLeftIconPressed
    extends State<ButtonTextGrayLeftIconPressed> {
  _ButtonTextGrayLeftIconPressed();
