...
class ButtonContainedWarningLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedWarningLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedWarningLeftIconDisabled createState() =>
      _ButtonContainedWarningLeftIconDisabled();
}

class _ButtonContainedWarningLeftIconDisabled
    extends State<ButtonContainedWarningLeftIconDisabled> {
  _ButtonContainedWarningLeftIconDisabled();
