...
class CircularButtonFloatingErrorDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFloatingErrorDisabled(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingErrorDisabled createState() =>
      _CircularButtonFloatingErrorDisabled();
}

class _CircularButtonFloatingErrorDisabled
    extends State<CircularButtonFloatingErrorDisabled> {
  _CircularButtonFloatingErrorDisabled();
