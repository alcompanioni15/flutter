...
class ButtonContainedAccentLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedAccentLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedAccentLeftIconDefault createState() =>
      _ButtonContainedAccentLeftIconDefault();
}

class _ButtonContainedAccentLeftIconDefault
    extends State<ButtonContainedAccentLeftIconDefault> {
  _ButtonContainedAccentLeftIconDefault();
