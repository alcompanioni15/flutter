...
class ButtonTextWarningLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextWarningLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextWarningLeftIconPressed createState() =>
      _ButtonTextWarningLeftIconPressed();
}

class _ButtonTextWarningLeftIconPressed
    extends State<ButtonTextWarningLeftIconPressed> {
  _ButtonTextWarningLeftIconPressed();
