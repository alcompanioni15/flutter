...
class ButtonOutlinedErrorLeftIconHover extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  final Widget? ovrCursorPointinghand;
  const ButtonOutlinedErrorLeftIconHover(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedErrorLeftIconHover createState() =>
      _ButtonOutlinedErrorLeftIconHover();
}

class _ButtonOutlinedErrorLeftIconHover
    extends State<ButtonOutlinedErrorLeftIconHover> {
  _ButtonOutlinedErrorLeftIconHover();
