...
class ChipsOutlinedClearDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrChiplabel;
  final Widget? ovriconoutlinedsuggestedcirclex;
  const ChipsOutlinedClearDefault(
    this.constraints, {
    Key? key,
    this.ovrChiplabel,
  ...
  @override
  _ChipsOutlinedClearDefault createState() => _ChipsOutlinedClearDefault();
}

class _ChipsOutlinedClearDefault extends State<ChipsOutlinedClearDefault> {
  _ChipsOutlinedClearDefault();
