...
class ChipsFilledLeftIconSelected extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrChiplabel;
  final Widget? ovriconoutlinedotherlocationmappin;
  const ChipsFilledLeftIconSelected(
    this.constraints, {
    Key? key,
    this.ovrChiplabel,
  ...
  @override
  _ChipsFilledLeftIconSelected createState() => _ChipsFilledLeftIconSelected();
}

class _ChipsFilledLeftIconSelected extends State<ChipsFilledLeftIconSelected> {
  _ChipsFilledLeftIconSelected();
