...
class IconOutlinedOtherVideoFilm extends StatefulWidget {
  ...
  const IconOutlinedOtherVideoFilm(
    this.constraints, {
    Key? key,
    this.ovrVector,
    this.ovrVector2,
  ...
  @override
  _IconOutlinedOtherVideoFilm createState() => _IconOutlinedOtherVideoFilm();
}

class _IconOutlinedOtherVideoFilm extends State<IconOutlinedOtherVideoFilm> {
  _IconOutlinedOtherVideoFilm();
