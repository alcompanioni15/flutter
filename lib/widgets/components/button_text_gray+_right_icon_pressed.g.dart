...
class ButtonTextGrayRightIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextGrayRightIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextGrayRightIconPressed createState() =>
      _ButtonTextGrayRightIconPressed();
}

class _ButtonTextGrayRightIconPressed
    extends State<ButtonTextGrayRightIconPressed> {
  _ButtonTextGrayRightIconPressed();
