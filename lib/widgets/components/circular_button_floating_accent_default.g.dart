...
class CircularButtonFloatingAccentDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  const CircularButtonFloatingAccentDefault(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFloatingAccentDefault createState() =>
      _CircularButtonFloatingAccentDefault();
}

class _CircularButtonFloatingAccentDefault
    extends State<CircularButtonFloatingAccentDefault> {
  _CircularButtonFloatingAccentDefault();
