...
class TextfieldContainedInputRightIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrPlaceholder;
  final Widget? ovriconoutlinedactioneyeeyeon;
  final String? ovrLabel;
  const TextfieldContainedInputRightIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrPlaceholder,
  ...
  @override
  _TextfieldContainedInputRightIconDisabled createState() =>
      _TextfieldContainedInputRightIconDisabled();
}

class _TextfieldContainedInputRightIconDisabled
    extends State<TextfieldContainedInputRightIconDisabled> {
  _TextfieldContainedInputRightIconDisabled();
