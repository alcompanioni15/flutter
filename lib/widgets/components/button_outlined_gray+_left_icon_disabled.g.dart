...
class ButtonOutlinedGrayLeftIconDisabled extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedGrayLeftIconDisabled(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedGrayLeftIconDisabled createState() =>
      _ButtonOutlinedGrayLeftIconDisabled();
}

class _ButtonOutlinedGrayLeftIconDisabled
    extends State<ButtonOutlinedGrayLeftIconDisabled> {
  _ButtonOutlinedGrayLeftIconDisabled();
