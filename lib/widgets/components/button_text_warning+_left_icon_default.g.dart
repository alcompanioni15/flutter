...
class ButtonTextWarningLeftIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextWarningLeftIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextWarningLeftIconDefault createState() =>
      _ButtonTextWarningLeftIconDefault();
}

class _ButtonTextWarningLeftIconDefault
    extends State<ButtonTextWarningLeftIconDefault> {
  _ButtonTextWarningLeftIconDefault();
