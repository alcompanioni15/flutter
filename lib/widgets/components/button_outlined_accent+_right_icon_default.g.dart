...
class ButtonOutlinedAccentRightIconDefault extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonOutlinedAccentRightIconDefault(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonOutlinedAccentRightIconDefault createState() =>
      _ButtonOutlinedAccentRightIconDefault();
}

class _ButtonOutlinedAccentRightIconDefault
    extends State<ButtonOutlinedAccentRightIconDefault> {
  _ButtonOutlinedAccentRightIconDefault();
