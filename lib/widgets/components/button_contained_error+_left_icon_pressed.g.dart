...
class ButtonContainedErrorLeftIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonContainedErrorLeftIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonContainedErrorLeftIconPressed createState() =>
      _ButtonContainedErrorLeftIconPressed();
}

class _ButtonContainedErrorLeftIconPressed
    extends State<ButtonContainedErrorLeftIconPressed> {
  _ButtonContainedErrorLeftIconPressed();
