...
class ButtonTextSuccessRightIconPressed extends StatefulWidget {
  final BoxConstraints constraints;
  final String? ovrButton;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ButtonTextSuccessRightIconPressed(
    this.constraints, {
    Key? key,
    this.ovrButton,
  ...
  @override
  _ButtonTextSuccessRightIconPressed createState() =>
      _ButtonTextSuccessRightIconPressed();
}

class _ButtonTextSuccessRightIconPressed
    extends State<ButtonTextSuccessRightIconPressed> {
  _ButtonTextSuccessRightIconPressed();
