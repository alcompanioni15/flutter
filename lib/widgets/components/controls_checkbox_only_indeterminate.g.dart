...
class ControlsCheckboxOnlyIndeterminate extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovriconoutlinedsuggestedsymbol;
  const ControlsCheckboxOnlyIndeterminate(
    this.constraints, {
    Key? key,
    this.ovriconoutlinedsuggestedsymbol,
  }) : super(key: key);
  @override
  _ControlsCheckboxOnlyIndeterminate createState() =>
      _ControlsCheckboxOnlyIndeterminate();
}

class _ControlsCheckboxOnlyIndeterminate
    extends State<ControlsCheckboxOnlyIndeterminate> {
  _ControlsCheckboxOnlyIndeterminate();
