...
class NavigationMenuhorizontalElementsItemLeftIconCleanDefault
    extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovriconoutlinedotherlocationhome;
  final String? ovrlabel;
  const NavigationMenuhorizontalElementsItemLeftIconCleanDefault(
    this.constraints, {
    Key? key,
  ...
  @override
  _NavigationMenuhorizontalElementsItemLeftIconCleanDefault createState() =>
      _NavigationMenuhorizontalElementsItemLeftIconCleanDefault();
}

class _NavigationMenuhorizontalElementsItemLeftIconCleanDefault
    extends State<NavigationMenuhorizontalElementsItemLeftIconCleanDefault> {
  _NavigationMenuhorizontalElementsItemLeftIconCleanDefault();
