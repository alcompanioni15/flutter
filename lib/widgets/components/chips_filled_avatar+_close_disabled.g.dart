...
class ChipsFilledAvatarCloseDisabled extends StatefulWidget {
  ...
  @override
  _ChipsFilledAvatarCloseDisabled createState() =>
      _ChipsFilledAvatarCloseDisabled();
}

class _ChipsFilledAvatarCloseDisabled
    extends State<ChipsFilledAvatarCloseDisabled> {
  _ChipsFilledAvatarCloseDisabled();
