...
class CircularButtonFilledErrorHover extends StatefulWidget {
  final BoxConstraints constraints;
  final Widget? ovrellipsebtn;
  final Widget? ovriconoutlinededitoractionedit;
  final Widget? ovrCursorPointinghand;
  const CircularButtonFilledErrorHover(
    this.constraints, {
    Key? key,
    this.ovrellipsebtn,
  ...
  @override
  _CircularButtonFilledErrorHover createState() =>
      _CircularButtonFilledErrorHover();
}

class _CircularButtonFilledErrorHover
    extends State<CircularButtonFilledErrorHover> {
  _CircularButtonFilledErrorHover();
